...
Каждый раз, когда вы активируете Второе дыхание Бонусным действием, вы можете переместиться на расстояние до половины вашей скорости, не вызывая провоцированных атак.
...
Кроме того, сразу после нанесения критического попадания вы можете переместиться на расстояние до половины вашей скорости, не вызывая провоцированных атак.
