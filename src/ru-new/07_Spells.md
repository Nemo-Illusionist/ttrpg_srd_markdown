...
Дубина или боевой посох, который вы держите, наполняется силой природы. На время действия заклинания вы можете использовать базовую характеристику заклинаний вместо Силы для бросков атаки и урона рукопашных атак этим оружием, и кость урона оружия становится d8. Если атака наносит урон, он может быть уроном Силой или обычным типом урона оружия (на ваш выбор).

Заклинание заканчивается досрочно, если вы сотворяете его снова или выпускаете оружие из рук.

**_Улучшение заговора._** Кость урона изменяется, когда вы достигаете 5-го уровня (d10), 11-го уровня (d12) и 17-го уровня (2d6).
...
Вы запускаете искру света в одно существо или объект в пределах дистанции. Совершите дальнобойную атаку заклинанием по цели. При попадании цель получает 1d8 урона Излучением, и до конца вашего следующего хода она излучает тусклый свет в радиусе 10 футов и не может получить выгоду от состояния «невидимый».
...
**Компоненты:** С, М (оружие, которым вы владеете и которое стоит 1+ мм)

**Длительность:** Мгновенная

Направляемый вспышкой магического озарения, вы совершаете одну атаку оружием, использованным при сотворении заклинания. Атака использует вашу базовую характеристику заклинаний для бросков атаки и урона вместо Силы или Ловкости. Если атака наносит урон, он может быть уроном Излучением или обычным типом урона оружия (на ваш выбор).

**_Улучшение заговора._** Независимо от того, наносите ли вы урон Излучением или обычный урон оружия, атака наносит дополнительный урон Излучением, когда вы достигаете 5-го уровня (1d6), 11-го уровня (2d6) и 17-го уровня (3d6).
...
Вы направляете чародейскую энергию в одно существо или объект в пределах дистанции. Совершите дальнобойную атаку заклинанием по цели. При попадании цель получает 1d8 урона выбранного вами типа: Кислотой, Холодом, Огнём, Молнией, Ядом, Психического или Звуком.

Если вы выбросили 8 на d8 для этого заклинания, вы можете бросить ещё один d8 и добавить его к урону. При сотворении этого заклинания максимальное количество таких d8, которые вы можете добавить к урону заклинания, равно вашему модификатору базовой характеристики заклинаний.
...
На время действия заклинания формируется клубящаяся штормовая туча с центром в точке в пределах дистанции и радиусом 300 футов. Каждое существо под тучей в момент её появления должно совершить спасбросок Телосложения. При провале существо получает 2d6 урона звуком и получает состояние «оглохший» на время действия заклинания.

В начале каждого из ваших последующих ходов буря производит различные эффекты, как описано ниже.

**_Ход 2._** Идёт кислотный дождь. Каждое существо и объект под тучей получает 4d6 урона кислотой.

**_Ход 3._** Вы призываете шесть молний из тучи, которые ударяют по шести разным существам или объектам под ней. Каждая цель совершает спасбросок Ловкости, получая 10d6 урона электричеством при провале или половину этого урона при успехе.

**_Ход 4._** Падает град. Каждое существо под тучей получает 2d6 дробящего урона.

**_Ходы 5–10._** Порывы ветра и ледяной дождь обрушиваются на область под тучей. Каждое существо там получает 1d6 урона холодом. До окончания заклинания область является труднопроходимой местностью и сильно заслонённой, дальнобойные атаки оружием в ней невозможны, и сильный ветер дует по всей области.
...
**Компоненты:** В, С, М (нефритовый венец стоимостью 1500+ зм)

**Длительность:** Концентрация, до 1 часа

Вы меняете свой облик на другое существо на время действия заклинания или пока не совершите действие Магия, чтобы принять другую подходящую форму. Новая форма должна быть существом с показателем опасности не выше вашего уровня или показателя опасности. Вы должны были видеть такой вид существа ранее, и это не может быть Конструкт или Нежить.

Когда вы сотворяете заклинание, вы получаете временные хиты в количестве, равном хитам первой формы, в которую вы превращаетесь. Эти временные хиты исчезают, если они остаются, когда заклинание заканчивается.

Ваша игровая статистика заменяется блоком характеристик выбранной формы, но вы сохраняете тип существа; мировоззрение; личность; Интеллект, Мудрость и Харизму; хиты; Кости Хитов; владения; и способность общаться. Если у вас есть умение Сотворение заклинаний, вы также его сохраняете.

При изменении облика вы определяете, падает ли ваше снаряжение на землю или меняет размер и форму, чтобы соответствовать новому облику, пока вы в нём.
...
Вы на короткое время останавливаете течение времени для всех, кроме себя. Для других существ время не идёт, пока вы совершаете 1d4 + 1 ходов подряд, в течение которых вы можете использовать действия и перемещаться как обычно.

Это заклинание заканчивается, если одно из действий, которые вы используете в этот период, или любые эффекты, которые вы создаёте в течение него, затрагивают существо, отличное от вас, или объект, который носит или несёт кто-то, кроме вас. Кроме того, заклинание заканчивается, если вы перемещаетесь более чем на 1000 футов от места, где вы его сотворили.
