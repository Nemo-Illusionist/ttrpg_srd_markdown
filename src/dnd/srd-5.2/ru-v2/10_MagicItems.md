...
| 1d100 | Result                                                                                                                                      |
|---|---|
| 01    | Both potions lose their effects, and the mixture creates a magical explosion in a 5-foot-radius Sphere centered on itself. Each creature in that area takes 4d10 урон Силовое поле. |
...
| 00    | Only one potion works, but its effects are permanent. Choose the simplest effect to make permanent or the one that seems the most fun. For example, a *Potion of Healing* might increase the drinker's Hit Point maximum by 2d4 + 2, or a *Зелье невидимости* might give the drinker the Невидимый condition indefinitely. At your discretion, a *Рассеивание магии* spell or similar magic might end this lasting effect. |
...
An item in the Scroll category is a roll of paper or parchment, sometimes attached to wooden rods and typically kept safe in a tube of ivory, jade, leather, metal, or wood. The most prevalent scroll is the *Свиток заклинания*, a spell stored in written form.
...
Common magic items, such as a *Potion of Healing*, are the most plentiful. Artifacts, such as the *Сферы драконов*, are priceless, unique, and difficult to acquire.
...
\*Halve the value for a consumable item other than a *Свиток заклинания*. The value of a *Свиток заклинания* is double what it costs to scribe the scroll (as specified in the "Scribing Spell Scrolls" section of "Equipment").
...
A command word is a word or short phrase that must be spoken or signed for an item to work. Spoken command words must be audible and fail to work in areas where all sound is suppressed, as in the area of the *Тишина* spell.
...
Some magic items have charges that must be expended to activate their properties. The number of charges an item has remaining is revealed when the *Опознание* spell is cast on it. A creature attuned to an item knows how many charges the item has and how many it regains.
...
A magic item's description specifies whether it bears a curse. Most methods of identifying items, including the *Опознание* spell, fail to reveal such a curse.

Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with a *Снятие проклятия* spell.
...
"Equipment" contains rules on brewing *Зелья лечения* and scribing *Spell Scrolls*. To create other magic items, follow the rules below. In these rules, "you" refers to the character crafting the magic item.
...
\*The time and cost are halved for a consumable item other than a *Свиток заклинания*, whose crafting time and cost are given in "Equipment."
...
### Свойства разумных магических предметов

When you make a sentient magic item, you create the item's persona much as you would create an NPC, with these exceptions.

#### Характеристики

A sentient magic item has Интеллект, Мудрость, and Харизма scores. Choose the item's abilities, or determine them randomly as follows: roll 4d6 for each one, dropping the lowest roll and totaling the rest.
...
| 4   | Hearing and Тёмное зрение out to 120 feet      |
...
When the bearer of a sentient item acts in a manner opposed to the item's alignment or purpose, conflict can arise. When such a conflict occurs, the item's bearer makes a Харизма saving throw (DC 12 plus the item's Харизма modifier). On a failed save, the item makes one or more of the following demands:
...
*Доспех (Any Medium or Heavy, Except Hide Доспех), Необычный*

This suit of armor is reinforced with adamantine, one of the hardest substances in existence. While you're wearing it, any Critical Hit against you becomes a normal hit.

#### Боеприпасы, +1, +2 или +3

*Оружие (Any Ammunition), Необычный (+1), Редкий (+2), or Very Редкий (+3)*
...
Your Телосложение is 19 while you wear this amulet. It has no effect on you if your Телосложение is 19 or higher without it.

#### Амулет защиты от обнаружения и локации

*Чудесный предмет, Необычный (Требует Настройки)*

While wearing this amulet, you can't be targeted by Прорицание spells or perceived through magical scrying sensors unless you allow it.

#### Амулет планов

*Чудесный предмет, Very Редкий (Требует Настройки)*

While wearing this amulet, you can take a Magic action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Интеллект (Arcana) check. On a successful check, you cast *Переход между планами*. On a failed check, you and each creature and object within 15 feet of you travel to a random destination determined by rolling 1d100 and consulting the following table.
...
*Доспех (Shield), Very Редкий (Требует Настройки)*

While holding this Shield, you can take a Bonus Action to cause it to animate. The Shield leaps into the air and hovers in your space to protect you as if you were wielding it, leaving your hands free. The Shield remains animate for 1 minute, until you take a Bonus Action to end this effect, or until you die or have the Недееспособный condition, at which point the Shield falls to the ground or into your hand if you have one free.

#### Аппарат краба

*Чудесный предмет, Легендарный*

This item first appears to be a sealed iron barrel weighing 500 pounds. The barrel has a hidden catch, which can be found with a successful DC 20 Интеллект (Investigation) check. Releasing the catch unlocks a hatch at one end of the barrel, allowing two Medium or smaller creatures to crawl inside. Ten levers are set in a row at the far end, each in a neutral position, able to move up or down. When certain levers are used, the apparatus transforms to resemble a giant lobster.

The *Аппарат краба* is a Large object with the following statistics: AC 20; HP 200; Speed 30 ft., Swim 30 ft. (or 0 ft. for both if the legs aren't extended); Immunity to Poison and урон Психический.

To be used as a vehicle, the apparatus requires one pilot. While the apparatus's hatch is closed, the compartment is airtight and watertight. The compartment holds enough air for 10 hours of breathing, divided by the number of breathing creatures inside.

The apparatus floats on water. It can also go underwater to a depth of 900 feet. Below that, the vehicle takes 2d6 урон Дробящий each minute from pressure.
...
| 5     | Each extended claw makes the following melee attack: +8 to hit, reach 5 ft. *Hit:* 7 (2d6) урон Дробящий. | Each extended claw makes the following melee attack: +8 to hit, reach 5 ft. *Hit:* The target has the Схваченный condition (escape DC 15). |
...
*Доспех (Any Light, Medium, or Heavy), Редкий (+1), Very Редкий (+2), or Легендарный (+3)*

You have a bonus to Armor Class while wearing this armor. The bonus is determined by its rarity.

#### Доспех неуязвимости

*Доспех (Plate Доспех), Легендарный (Требует Настройки)*

You have Resistance to Bludgeoning, Piercing, and урон Рубящий while you wear this armor.

*Metal Shell.* You can take a Magic action to give yourself Immunity to Bludgeoning, Piercing, and урон Рубящий for 10 minutes or until you are no longer wearing the armor. Once this property is used, it can't be used again until the next dawn.

#### Доспех сопротивления

*Доспех (Any Light, Medium, or Heavy), Редкий (Требует Настройки)*
...
*Curse.* This armor is cursed, a fact that is revealed only when the *Опознание* spell is cast on the armor or you attune to it. Attuning to the armor curses you until you are targeted by a *Снятие проклятия* spell or similar magic; removing the armor fails to end the curse. While cursed, you have Vulnerability to two of the three damage types associated with the armor (not the one to which it grants Resistance).

#### Щит притяжения снарядов

*Доспех (Shield), Редкий (Требует Настройки)*
...
If you dump one or more beans out of the bag, they explode in a 10-foot-radius Sphere centered on them. All the dumped beans are destroyed in the explosion, and each creature in the Sphere, including you, makes a DC 15 Ловкость saving throw, taking 5d4 урон Силовое поле on a failed save or half as much damage on a successful one.
...
| 1d100 | Effect                   |
|---|---|
| 01    | 5d4 toadstools sprout. If a creature eats a toadstool, roll any die. On an odd roll, the eater must succeed on a DC 15 Телосложение saving throw or take 5d6 урон Яд and have the Отравленный condition for 1 hour. On an even roll, the eater gains 5d6 Temporary Hit Points for 1 hour. |
...
| 81–90 | A nest of 1d4 + 3 rainbow-colored eggs springs up. Any creature that eats an egg makes a DC 20 Телосложение saving throw. On a successful save, a creature permanently increases its lowest ability score by 1, randomly choosing among equally low scores. On a failed save, the creature takes 10d6 урон Силовое поле from an internal explosion. |
...
*Чудесный предмет, Very Редкий*

This bag resembles a *Сумка вместимости* but is a feeding orifice for a gigantic extradimensional creature. Turning the bag inside out closes the orifice.

The extradimensional creature attached to the bag can sense whatever is placed inside the bag. Animal or vegetable matter placed wholly in the bag is devoured and lost forever. When part of a living creature is placed in the bag, as happens when someone reaches inside it, there is a 50 percent chance that the creature is pulled inside the bag. A creature inside the bag can take an action to try to escape, doing so with a successful DC 15 Сила (Athletics) check. Another creature can take an action to reach into the bag to pull a creature out, doing so with a successful DC 20 Сила (Athletics) check, provided the puller isn't pulled inside the bag first. Any creature that starts its turn inside the bag is devoured, its body destroyed.
...
**Friend of Dwarvenkind.** You have Advantage on Харизма (Persuasion) checks made to interact with dwarves and duergar.

**Toughness.** Your Телосложение increases by 2, to a maximum of 20.
...
**Тёмное зрение.** You have Тёмное зрение with a range of 60 feet.

**Resilience.** You have Resistance to урон Яд. You also have Advantage on saving throws you make to avoid or end the Отравленный condition.

#### Пояс силы великана

*Чудесный предмет, Rarity Varies (Требует Настройки)*

While wearing this belt, your Сила changes to a score granted by the belt. The type of giant determines the score (see the table below). The item has no effect on you if your Сила without the belt is equal to or greater than the belt's score.

| Belt                                    | Str. | Rarity    |
|---|---|---|
| Belt of Giant Сила (hill)           | 21   | Rare      |
| Belt of Giant Сила (frost or stone) | 23   | Very Rare |
| Belt of Giant Сила (fire)           | 25   | Very Rare |
| Belt of Giant Сила (cloud)          | 27   | Legendary |
| Belt of Giant Сила (storm)          | 29   | Legendary |

#### Топор берсерка

*Оружие (Battleaxe, Greataxe, or Halberd), Редкий (Требует Настройки)*
...
Whenever another creature damages you while the weapon is in your possession, you must succeed on a DC 15 Мудрость saving throw or go berserk. This berserk state ends when you start your turn and there are no creatures within 60 feet of you that you can see or hear.
...
While you wear these boots, your steps make no sound, regardless of the surface you are moving across. You also have Advantage on Ловкость (Stealth) checks.

#### Сапоги левитации

*Чудесный предмет, Редкий (Требует Настройки)*

While you wear these boots, you can cast *Левитация* on yourself.
...
**_Cold Resistance._** You have Resistance to урон Холод and can tolerate temperatures of 0 degrees Fahrenheit or lower without any additional protection.
...
#### Жаровня призыва огненных элементалей
...
While wearing this brooch, you have Resistance to урон Силовое поле, and you have Immunity to damage from the *Магическая стрела* spell.
...
Alternatively, when you light the candle for the first time, you can cast *Врата* with it. Doing so destroys the candle. The portal created by the spell links to a particular Outer Plane chosen by the GM or determined by rolling on the following table.
...
This cape smells faintly of brimstone. While wearing it, you can use it to cast *Дверь измерений* as a Magic action. This property can't be used again until the next dawn.
...
Four sizes of *Ковёр-самолёт* exist. The GM chooses the size of a given carpet or determines it randomly by rolling on the following table. A carpet can carry up to twice the weight shown on the table, but its Fly Speed is halved if it carries more than its normal capacity.
...
#### Кадильница управления воздушными элементалями
...
This hollow metal tube measures about 1 foot long and weighs 1 pound. As a Magic action, you can strike the chime to cast *Открывание*. The spell's customary knocking sound is replaced by the clear, ringing tone of the chime, which is audible out to 300 feet.
...
While wearing this circlet, you can cast *Палящий луч* with it (+5 to hit). The circlet can't cast this spell again until the next dawn.
...
**_Poison Resistance._** You have Resistance to урон Яд.
...
**_Web._** You can cast *Паутина* (save DC 13). The web created by the spell fills twice its normal area. Once used, this property can't be used again until the next dawn.
...
While you wear this cloak, Мудрость (Perception) checks made to perceive you have Disadvantage, and you have Advantage on Ловкость (Stealth) checks.

#### Плащ невидимости

*Чудесный предмет, Легендарный (Требует Настройки)*

This cloak has 3 charges and regains 1d3 expended charges daily at dawn. While wearing the cloak, you can take a Magic action to pull its hood over your head and expend 1 charge to give yourself the Невидимый condition for 1 hour. The effect ends early if you pull the hood down (no action required) or cease wearing the cloak.
...
While wearing this cloak, you have Advantage on Ловкость (Stealth) checks. In an area of Dim Light or Darkness, you can grip the edges of the cloak and use it to gain a Fly Speed of 40 feet. If you ever fail to grip the cloak's edges while flying in this way, or if you are no longer in Dim Light or Darkness, you lose this Fly Speed.

While wearing the cloak in an area of Dim Light or Darkness, you can cast *Превращение* on yourself, shape-shifting into a **Bat**. While in that form, you retain your Интеллект, Мудрость, and Харизма scores. The cloak can't be used this way again until the next dawn.
...
While touching this crystal orb, you can cast *Наблюдение* (save DC 17) with it.

#### Кристальный шар чтения мыслей

*Чудесный предмет, Легендарный (Требует Настройки)*

While touching this crystal orb, you can cast *Наблюдение* (save DC 17) with it. In addition, you can cast *Обнаружение мыслей* (save DC 17) targeting creatures you can see within 30 feet of the spell's sensor. You don't need to concentrate on this *Обнаружение мыслей* spell to maintain it during its duration, but it ends if the *Наблюдение* spell ends.

#### Кристальный шар телепатии

*Чудесный предмет, Легендарный (Требует Настройки)*

While touching this crystal orb, you can cast *Наблюдение* (save DC 17) with it. In addition, you can communicate telepathically with creatures you can see within 30 feet of the spell's sensor. You can also cast *Внушение* (save DC 17) through the sensor on one of those creatures. You don't need to concentrate on this *Внушение* to maintain it during its duration, but it ends if *Наблюдение* ends. You can't cast *Внушение* in this way again until the next dawn.

#### Кристальный шар истинного зрения

*Чудесный предмет, Легендарный (Требует Настройки)*

While touching this crystal orb, you can cast *Наблюдение* (save DC 17) with it. In addition, you have Истинное зрение with a range of 120 feet centered on the spell's sensor.
...
**_Gate._** Pressing one side of the cube, you cast *Врата*, opening a portal to the plane of existence keyed to that side.

**_Plane Shift._** Pressing one side of the cube twice, you cast *Переход между планами*, transporting the targets to the plane of existence keyed to that side.

#### Кинжал яда

*Оружие (Dagger), Редкий*

You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon.

You can take a Bonus Action to magically coat the blade with poison. The poison remains for 1 minute or until an attack using this weapon hits a creature. That creature must succeed on a DC 15 Телосложение saving throw or take 2d10 урон Яд and have the Отравленный condition for 1 minute. The weapon can't be used this way again until the next dawn.

#### Танцующий меч

*Оружие (Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Редкий (Требует Настройки)*
...
**Geyser.** The decanter produces 30 gallons of water that gushes forth in a Line 30 feet long and 1 foot wide. If you're holding the decanter, you can aim the geyser in one direction (no action required). One creature of your choice in the Line must succeed on a DC 13 Сила saving throw or take 1d4 урон Дробящий and have the Лежащий condition. Instead of a creature, you can target one object in the Line that isn't being worn or carried and that weighs no more than 200 pounds. The object is knocked over by the geyser.
...
Any physical interaction with the illusory creature reveals it to be false, because objects pass through it. A creature that takes a Study action to visually inspect the illusory creature identifies it as an illusion with a successful DC 15 Интеллект (Investigation) check. The illusion lasts until its card is moved or the illusion is dispelled (using a *Рассеивание магии* spell or a similar effect). When the illusion ends, the image on its card disappears, and that card can't be used again.
...
*Оружие (Any Melee Оружие), Легендарный (Требует Настройки)*
...
*Доспех (Any Light, Medium, or Heavy), Very Редкий (Требует Настройки)*

While wearing this armor, you gain a +1 bonus to Armor Class, and you know Abyssal. In addition, the armor's clawed gauntlets allow your Unarmed Strikes to deal 1d8 урон Рубящий instead of the usual урон Дробящий, and you gain a +1 bonus to the attack and damage rolls of your Unarmed Strikes.

**_Curse._** Once you don this cursed armor, you can't doff it unless you are targeted by a *Снятие проклятия* spell or similar magic. While wearing the armor, you have Disadvantage on attack rolls against demons and on saving throws against their spells and special abilities.

#### Межпространственные кандалы

*Чудесный предмет, Редкий*

You can take a Utilize action to place these shackles on a creature that has the Недееспособный condition. The shackles adjust to fit a creature of Small to Large size. The shackles prevent a creature bound by them from using any method of extradimensional movement, including teleportation or travel to a different plane of existence. They don't prevent the creature from passing through an interdimensional portal.

You and any creature you designate when you use the shackles can take a Utilize action to remove them. Once every 30 days, the bound creature can make a DC 30 Сила (Athletics) check. On a successful check, the creature breaks free and destroys the shackles.
...
While attuned to an orb, you can take a Magic action to peer into the orb's depths. You must then make a DC 15 Харизма saving throw. On a successful save, you control the orb for as long as you remain attuned to it. On a failed save, the orb imposes the Очарованный condition on you for as long as you remain attuned to it.

While you are Очарованный by the orb, you can't voluntarily end your Attunement to it, and the orb casts *Внушение* on you at will (save DC 18), urging you to work toward the evil ends it desires. The dragon essence within the orb might want many things: the annihilation of a particular society or organization, freedom from the orb, to spread suffering in the world, to advance the worship of Tiamat, or something else the GM decides.
...
**_Destroying an Orb._** A *Сферы драконов* has AC 20 and is destroyed if it takes damage from a *+3 Weapon* or a *Распыление* spell. Nothing else can harm it.

#### Драконья чешуйчатая кольчуга

*Доспех (Scale Mail), Very Редкий (Требует Настройки)*

*Драконья чешуйчатая кольчуга* is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them. Other times, hunters carefully preserve the hide of a dead dragon. In either case, *Драконья чешуйчатая кольчуга* is highly valued.
...
*Оружие (Any Simple or Martial), Редкий*
...
This powder resembles fine sand. There is enough of it for one use. When you take a Utilize action to throw the dust into the air, you and each creature and object within a 10-foot Emanation originating from you have the Невидимый condition for 2d4 minutes. The duration is the same for all subjects, and the dust is consumed when its magic takes effect. Immediately after an affected creature makes an attack roll, deals damage, or casts a spell, the Невидимый condition ends for that creature.
...
As a Utilize action, you can sprinkle a pinch of the dust on an Elemental within 5 feet of yourself that is composed mostly of water (such as a **Water Elemental**). Such a creature exposed to a pinch of the dust makes a DC 13 Телосложение saving throw, taking 10d6 урон Некротический on a failed save or half as much damage on a successful one.

#### Пыль чихания и удушья

*Чудесный предмет, Необычный*

Found in a small container, this powder resembles *Пыль исчезновения*, and *Опознание* reveals it to be such. There is enough of it for one use.

As a Utilize action, you can throw the dust into the air, forcing yourself and every creature in a 30-foot Emanation originating from you to make a DC 15 Телосложение saving throw. Constructs, Elementals, Oozes, Plants, and Undead succeed on the save automatically.

On a failed save, a creature begins sneezing uncontrollably; it has the Недееспособный condition and is suffocating. The creature repeats the save at the end of each of its turns, ending the effect on itself on a success. The effect also ends on any creature targeted by a *Малое восстановление* spell.

#### Дварфийский латный доспех

*Доспех (Half Plate Доспех or Plate Доспех), Very Редкий*

While wearing this armor, you gain a +2 bonus to Armor Class. In addition, if an effect moves you against your will along the ground, you can take a Reaction to reduce the distance you are moved by up to 10 feet.

#### Дварфийский метатель

*Оружие (Warhammer), Very Редкий (Требует Настройки by a Dwarf or a Creature Attuned to a Belt of Dwarvenkind)*

You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. It has the Thrown property with a normal range of 20 feet and a long range of 60 feet. When you hit with a ranged attack using this weapon, it deals an extra 1d8 урон Силовое поле, or an extra 2d8 урон Силовое поле if the target is a Giant. Immediately after hitting or missing, the weapon flies back to your hand.
...
| 10   | The efreeti understands your languages and can cast *Исполнение желаний* once for you. It disappears when it grants the wish or after 1 hour, and the bottle loses its magic. |
...
When you drink this potion, you are cured of all magical contagions. In addition, the following conditions end on you: Ослеплённый, Оглохший, Парализованный, and Отравленный.

The clear, red liquid has tiny bubbles of light in it.

#### Эльфийская кольчуга

*Доспех (Chain Mail or Chain Shirt), Редкий*
...
*Оружие (Longbow or Shortbow), Very Редкий (Требует Настройки)*

You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon, which has no string. Each time you pull your arm back in a firing motion, a magical arrow made of golden energy appears nocked and ready to fire. An arrow produced by this weapon deals урон Силовое поле instead of урон Колющий on a hit, and it disappears after it hits or misses its target. Until it disappears, the arrow emits Bright Light in a 20-foot radius and Dim Light for an additional 20 feet.

This weapon has the following additional properties.

**_Arrow of Restraint._** Whenever you use this weapon to make a ranged attack against a creature, you can try to restrain the target instead of dealing damage to it. If the arrow hits, the target must succeed on a DC 15 Сила saving throw or have the Опутанный condition for 1 minute. As an action, a creature Опутанный by an arrow can make a DC 20 Сила (Athletics) check to try to break the restraint, ending the effect on itself on a successful check.
...
Closing the bottle causes the cloud to become fixed in place until it disperses after 10 minutes. A strong wind (such as that created by the *Порыв ветра* spell) disperses the cloud after 1 minute.

#### Глаза очарования

*Чудесный предмет, Необычный (Требует Настройки)*

These crystal lenses fit over the eyes. They have 3 charges. While wearing them, you can expend 1 or more charges to cast *Очарование личности* (save DC 13). For 1 charge, you cast the level 1 version of the spell. You increase the spell's level by one for each additional charge you expend. The lenses regain all expended charges daily at dawn.

#### Очки мелкого зрения

*Чудесный предмет, Необычный*

These crystal lenses fit over the eyes. While wearing them, your vision improves significantly out to a range of 1 foot, granting you Тёмное зрение within that range and Advantage on Интеллект (Investigation) checks made to examine something within that range.

#### Глаза орла

*Чудесный предмет, Необычный*

These crystal lenses fit over the eyes. While wearing them, you have Advantage on Мудрость (Perception) checks that rely on sight. In conditions of clear visibility, you can make out details of even extremely distant creatures and objects as small as 2 feet across.

#### Перо-талисман

*Чудесный предмет, Rarity Varies*
...
**_Whip (Rare)._** You can take a Magic action to throw the token to a point within 10 feet of yourself. The token disappears, and a floating whip takes its place. You can then take a Bonus Action to make a melee spell attack against a creature within 10 feet of the whip, with an attack bonus of +9. On a hit, the target takes 1d6 + 5 урон Силовое поле.

As a Bonus Action, you can direct the whip to fly up to 20 feet and repeat the attack against a creature within 10 feet of the whip. The whip disappears after 1 hour, when you take a Magic action to dismiss it, or when you die or have the Недееспособный condition.
...
A *Образная фигурка чудесной силы* is a statuette small enough to fit in a pocket. If you take a Magic action to throw the figurine to a point on the ground within 60 feet of yourself, the figurine becomes a living creature specified in the figurine's description below. If the space where the creature would appear is occupied by other creatures or objects, or if there isn't enough space for the creature, the figurine doesn't become a creature.
...
> **ХП** 15 (3d10 + 3)
>
> **Скорость** Speed 30 ft., Fly 60 ft.
>
...
> | Cha       | 3     | -4  | -4   |
>
> **Senses** Тёмное зрение 60 ft., Passive Perception 10
>
> **Languages** None
>
> **ПО** 0 (XP 0; PB +2)
...
**_Onyx Dog (Rare)._** This onyx statuette of a dog can become a **Mastiff** for up to 6 hours. The mastiff has an Интеллект of 8 and can speak Common. It also has Слепое зрение with a range of 60 feet. Once it has been used, it can't be used again until 7 days have passed.
...
**_Silver Raven (Uncommon)._** This silver statuette of a raven can become a **Raven** for up to 12 hours. Once it has been used, it can't be used again until 2 days have passed. While in raven form, the figurine grants you the ability to cast *Животный посланник* on it.

#### Пламенный язык

*Оружие (Any Melee Оружие), Редкий (Требует Настройки)*

While holding this magic weapon, you can take a Bonus Action and use a command word to cause flames to engulf the damage-dealing part of the weapon. These flames shed Bright Light in a 40 foot radius and Dim Light for an additional 40 feet. While the weapon is ablaze, it deals an extra 2d6 урон Огонь on a hit. The flames last until you take a Bonus Action to issue the command again or until you drop, stow, or sheathe the weapon.
...
**Third Command Word.** The *Складная лодка* folds back into a box if no creatures are aboard. Any objects in the vessel that can't fit inside the box remain outside the box as it folds. Any objects in the vessel that can fit inside the box do so.

When the box becomes a vessel, its weight becomes that of a normal vessel its size, and anything that was stored in the box remains in the boat.

Statistics for the Rowboat and Keelboat appear in "Equipment." If either vessel is reduced to 0 Hit Points, the *Складная лодка* is destroyed.

#### Морозный клинок

*Оружие (Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Редкий (Требует Настройки)*

When you hit with an attack roll using this magic weapon, the target takes an extra 1d6 урон Холод. In addition, while you hold the weapon, you have Resistance to урон Огонь.
...
Your Сила is 19 while you wear these gauntlets. They have no effect on you if your Сила is 19 or higher without them.
...
This gem has 3 charges. As a Magic action, you can expend 1 charge. For the next 10 minutes, you have Истинное зрение out to 120 feet when you peer through the gem.
...
When you hit a Giant with this weapon, the Giant takes an extra 2d6 damage of the weapon's type and must succeed on a DC 15 Сила saving throw or have the Лежащий condition.

#### Гламурная клёпаная кожа

*Доспех (Studded Leather Доспех), Редкий*
...
If you're hit by an attack roll made with a Ranged or Thrown weapon while wearing these gloves, you can take a Reaction to reduce the damage by 1d10 plus your Ловкость modifier if you have a free hand. If you reduce the damage to 0, you can catch the ammunition or weapon if it is small enough for you to hold in that hand.

#### Перчатки плавания и лазания

*Чудесный предмет, Необычный (Требует Настройки)*

While wearing these gloves, you have a Climb Speed and a Swim Speed equal to your Speed, and you gain a +5 bonus to Сила (Athletics) checks made to climb or swim.

#### Воровские перчатки

*Чудесный предмет, Необычный*

These gloves are imperceptible while worn. While wearing them, you gain a +5 bonus to Ловкость (Sleight of Hand) checks.

#### Очки ночного видения

*Чудесный предмет, Необычный*

While wearing these dark lenses, you have Тёмное зрение out to 60 feet. If you already have Тёмное зрение, wearing the goggles increases its range by 60 feet.

#### Молот громовержца

*Оружие (Maul or Warhammer), Легендарный (Требует Настройки)*

You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon.

The weapon has 5 charges. You can expend 1 charge and make a ranged attack with the weapon, hurling it as if it had the Thrown property with a normal range of 20 feet and a long range of 60 feet. If the attack hits, the weapon unleashes a thunderclap audible out to 300 feet. The target and every creature within 30 feet of it other than you must succeed on a DC 17 Телосложение saving throw or have the Ошеломлённый condition until the end of your next turn. Immediately after hitting or missing, the weapon flies back to your hand. The weapon regains 1d4 + 1 expended charges daily at dawn.

**_Giant's Bane._** While you are attuned to the weapon and wearing either a *Belt of Giant Сила* or *Перчатки силы огра* to which you are also attuned, you gain the following benefits:

**Giants' Bane.** When you roll a 20 on the d20 for an attack roll made with this weapon against a Giant, the creature must succeed on a DC 17 Телосложение saving throw or die.

**Might of Giants.** The Сила score bestowed by your *Belt of Giant Сила* or *Перчатки силы огра* increases by 4, to a maximum of 30.
...
While wearing this hat, you can cast the *Маскировка* spell. The spell ends if the hat is removed.

#### Шляпа множества заклинаний

*Чудесный предмет, Very Редкий (Требует Настройки by a Волшебник)*

This pointed hat has the following properties.

**_Использование заклинаний Focus._** While holding the hat, you can use it as a Spellcasting Focus for your Wizard spells. Any spell you cast using the hat gains a special Somatic component: you must reach into the hat and "pull" the spell out of it.

**_Unknown Spell._** While holding the hat, you can try to cast a level 1+ spell you don't know. The spell must be on the Wizard spell list, it must be of a level you can cast, and it can't have Material components costing more than 1,000 GP. Once you decide on the spell, you must expend a spell slot of the spell's level. Then, to determine whether you cast the spell, make an Интеллект (Arcana) check (DC 10 plus the spell's level). On a successful check, you cast the spell using its normal casting time, and you can't use this property again until you finish a Short or Long Rest. On a failed check, you fail to cast the spell and a random effect occurs instead, determined by rolling on the following table.
...
| 51–55 | You have the Ошеломлённый condition until the end of your next turn, believing something awesome just happened.      |
...
| 66–70 | You suffer a bout of "magic sickness" and have the Отравленный condition for 1 hour.      |
| 71–75 | You have the Окаменевший condition until the end of your next turn.      |
...
Your Интеллект is 19 while you wear this headband. It has no effect on you if your Интеллект is 19 or higher without it.
...
**_Diamond Light._** As long as it has at least one diamond, the helm emits a 30-foot Emanation. When at least one Undead is within that area, the Emanation is filled with Dim Light. Any Undead that starts its turn in that area takes 1d6 урон Излучение.

**_Fire Opal Flames._** As long as the helm has at least one fire opal, you can take a Magic action to cause one weapon you are holding to burst into flames. The flames emit Bright Light in a 10-foot radius and Dim Light for an additional 10 feet. The flames are harmless to you and the weapon. When you hit with an attack using the blazing weapon, the target takes an extra 1d6 урон Огонь. The flames last until you take a Bonus Action to extinguish them or until you drop or stow the weapon.

**_Ruby Resistance._** As long as the helm has at least one ruby, you have Resistance to урон Огонь.

**_Spells._** You can cast one of the following spells (save DC 18), using one of the helm's gems of the specified type as a component: *Дневной свет* (opal), *Огненный шар* (fire opal), *Радужные брызги* (diamond), or *Стена огня* (ruby). The gem is destroyed when the spell is cast and disappears from the helm.

**_Taking Fire Damage._** Roll 1d20 if you are wearing the helm and take урон Огонь as a result of failing a saving throw against a spell. On a roll of 1, the helm emits beams of light from its remaining gems and is then destroyed. Each creature within a 60 foot Emanation originating from you must succeed on a DC 17 Ловкость saving throw or be struck by a beam, taking урон Излучение equal to the number of gems in the helm.

#### Шлем понимания языков

*Чудесный предмет, Необычный*

While wearing this helm, you can cast *Понимание языков* from it.

#### Шлем телепатии

*Чудесный предмет, Необычный (Требует Настройки)*

While wearing this helm, you have telepathy with a range of 30 feet, and you can cast *Обнаружение мыслей* or *Внушение* (save DC 13) from the helm. Once either spell is cast from the helm, that spell can't be cast from it again until the next dawn.

#### Шлем телепортации

*Чудесный предмет, Редкий (Требует Настройки)*

This helm has 3 charges. While wearing it, you can expend 1 charge to cast *Телепорт* from it. The helm regains 1d3 expended charges daily at dawn.

#### Святой заступник

*Оружие (Any Simple or Martial), Легендарный (Требует Настройки by a Паладин)*

You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. When you hit a Fiend or an Undead with it, that creature takes an extra 2d10 урон Излучение.
...
You can take a Magic action to blow the horn, which emits a thunderous blast in a 30-foot Cone that is audible out to 600 feet. Each creature in the Cone makes a DC 15 Телосложение saving throw. On a failed save, a creature takes 5d8 урон Гром and has the Оглохший condition for 1 minute. On a successful save, a creature takes half as much damage only. Glass or crystal objects in the Cone that aren't being worn or carried take 10d8 урон Гром.

Each use of the horn's magic has a 20 percent chance of causing the horn to explode. The explosion deals 10d6 урон Силовое поле to the user and destroys the horn.

#### Рог Валгаллы

*Чудесный предмет, Редкий (Silver or Brass), Very Редкий (Bronze), or Легендарный (Iron)*

You can take a Magic action to blow this horn. In response, warrior spirits from the plane of Ysgard appear in unoccupied spaces within 60 feet of you. Each spirit uses the **Berserker** stat block and returns to Ysgard after 1 hour or when it drops to 0 Hit Points. The spirits look like living, breathing warriors, and they have Immunity to the Очарованный and Испуганный conditions. Once you use the horn, it can't be used again until 7 days have passed.

Four types of *Рог Валгаллы* are known to exist, each made of a different metal. The horn's type determines how many spirits it summons, as well as the requirement for its use. The GM chooses the horn's type or determines it randomly by rolling on the following table.
...
The tower is 20 feet on a side and 30 feet high, with arrow slits on all sides and a battlement atop it. Its interior is divided into two floors, with a ladder, staircase, or ramp (your choice) connecting them. This ladder, staircase, or ramp ends at a trapdoor leading to the roof. When created, the tower has a single door at ground level on the side facing you. The door opens only at your command, which you can issue as a Bonus Action. It is immune to the *Открывание* spell and similar magic.

Magic prevents the tower from being tipped over. The roof, the door, and the walls each have AC 20; HP 100; Immunity to Bludgeoning, Piercing, and урон Рубящий except that which is dealt by siege equipment; and Resistance to all other damage. Shrinking the tower back down to statuette form doesn't repair damage to the tower. Only a *Исполнение желаний* spell can repair the tower (this use of the spell counts as replicating a spell of level 8 or lower). Each casting of *Исполнение желаний* causes the tower to regain all its Hit Points.
...
When you take a Magic action to toss an *Боевой камень Иуна* into the air, the stone orbits your head at a distance of 1d3 feet, conferring its benefit to you while doing so. You can have up to three *Ioun Stones* orbiting your head at the same time.

Each *Боевой камень Иуна* orbiting your head is considered to be an object you are wearing. The orbiting stone avoids contact with other creatures and objects, adjusting its orbit to avoid collisions and thwarting all attempts by other creatures to attack or snatch it.

As a Utilize action, you can seize and stow any number of *Ioun Stones* orbiting your head. If your Attunement to an *Боевой камень Иуна* ends while it's orbiting your head, the stone falls as though you had dropped it.
...
**_Agility (Very Rare)._** Your Ловкость increases by 2, to a maximum of 20, while this deep-red sphere orbits your head.

**_Awareness (Rare)._** While this dark-blue rhomboid orbits your head, you have Advantage on Initiative rolls and Мудрость (Perception) checks.

**_Fortitude (Very Rare)._** Your Телосложение increases by 2, to a maximum of 20, while this pink rhomboid orbits your head.
...
**_Insight (Very Rare)._** Your Мудрость increases by 2, to a maximum of 20, while this incandescent blue sphere orbits your head.

**_Intellect (Very Rare)._** Your Интеллект increases by 2, to a maximum of 20, while this marbled scarlet and blue sphere orbits your head.

**_Leadership (Very Rare)._** Your Харизма increases by 2, to a maximum of 20, while this marbled pink and green sphere orbits your head.
...
**_Strength (Very Rare)._** Your Сила increases by 2, to a maximum of 20, while this pale blue rhomboid orbits your head.
...
Make a ranged attack roll with an attack bonus equal to your Ловкость modifier plus your Proficiency Bonus. On a hit, the target has the Опутанный condition until you take a Bonus Action to issue a command that releases it. Doing so or missing with the attack causes the bands to contract and become a sphere once more.

A creature that can touch the bands, including the one Опутанный, can take an action to make a DC 20 Сила (Athletics) check to break the iron bands. On a successful check, the item is destroyed, and the Опутанный creature is freed. On a failed check, any further attempts made by that creature automatically fail until 24 hours have elapsed.
...
An *Опознание* spell reveals if the flask contains a creature, but the only way to determine the type of creature is to open the flask. A newly discovered *Железная фляга* might already contain a creature chosen by the GM.

#### Копьё молнии

*Оружие (Javelin), Необычный*

Each time you make an attack roll with this magic weapon and hit, you can have it deal урон Электричество instead of урон Колющий.

*Lightning Bolt.* When you throw this weapon at a target no farther than 120 feet from you, you can forgo making a ranged attack roll and instead turn the weapon into a bolt of lightning. This bolt forms a 5-foot-wide Line between you and the target. The target and each other creature in the Line (excluding you) makes a DC 13 Ловкость saving throw, taking 4d6 урон Электричество on a failed save or half as much damage on a successful one. Immediately after dealing this damage, the weapon reappears in your hand. This property can't be used again until the next dawn.

#### Фонарь раскрытия

*Чудесный предмет, Необычный*

While lit, this hooded lantern burns for 6 hours on 1 pint of oil, shedding Bright Light in a 30-foot radius and Dim Light for an additional 30 feet. Невидимый creatures and objects are visible as long as they are in the lantern's Bright Light. You can take a Utilize action to lower the hood, reducing the lantern's light to Dim Light in a 5-foot radius.

#### Удача (клинок)

*Оружие (Glaive, Greatsword, Longsword, Rapier, Scimitar, Sickle, or Shortsword), Легендарный (Требует Настройки)*
...
*Luck.* If the weapon is on your person, you can call on its luck (no action required) to reroll one failed D20 Test if you don't have the Недееспособный condition. You must use the second roll. Once used, this property can't be used again until the next dawn.

*Wish.* The weapon has 1d3 charges. While holding it, you can expend 1 charge and cast *Исполнение желаний* from it. Once used, this property can't be used again until the next dawn. The weapon loses this property if it has no charges.

#### Булава разрушения

*Оружие (Mace), Редкий (Требует Настройки)*

When you hit a Fiend or an Undead with this magic weapon, that creature takes an extra 2d6 урон Излучение. If the target has 25 Hit Points or fewer after taking this damage, it must succeed on a DC 15 Мудрость saving throw or be destroyed. On a successful save, the creature has the Испуганный condition until the end of your next turn.
...
When you roll a 20 on an attack roll made with this weapon, the target takes an extra 7 урон Дробящий, or 14 урон Дробящий if it's a Construct. If a Construct has 25 Hit Points or fewer after taking this damage, it is destroyed.

#### Булава ужаса

*Оружие (Mace), Редкий (Требует Настройки)*

This magic weapon has 3 charges and regains 1d3 expended charges daily at dawn. While holding the weapon, you can take a Magic action and expend 1 charge to release a wave of terror from it. Each creature of your choice within 30 feet of you must succeed on a DC 15 Мудрость saving throw or have the Испуганный condition for 1 minute. While Испуганный in this way, a creature must spend its turns trying to move as far away from you as it can, and it can't make Opportunity Attacks. For its action, it can use only the Dash action or try to escape from an effect that prevents it from moving. If it has nowhere it can move, the creature can take the Dodge action. At the end of each of its turns, a creature repeats the save, ending the effect on itself on a success.
...
This book contains health and nutrition tips, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Телосложение increases by 2, to a maximum of 30. The manual then loses its magic but regains it in a century.

#### Мануал полезных упражнений

*Чудесный предмет, Very Редкий*

This book describes fitness exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Сила increases by 2, to a maximum of 30. The manual then loses its magic but regains it in a century.

#### Мануал големов

*Чудесный предмет, Very Редкий*

This tome contains information and incantations necessary to make a particular type of golem. The GM chooses the type or determines it randomly by rolling on the accompanying table. To decipher and use the manual, you must be a spellcaster with at least two level 5 spell slots. A creature that can't use a *Мануал големов* and attempts to read it takes 6d6 урон Психический.
...
This book contains coordination and balance exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Ловкость increases by 2, to a maximum of 30. The manual then loses its magic but regains it in a century.
...
The medallion has 5 charges. While wearing it, you can expend 1 charge to cast *Обнаружение мыслей* (save DC 13) from it. The medallion regains 1d4 expended charges daily at dawn.

#### Зеркало заточения

*Чудесный предмет, Very Редкий*

When this 4-foot-tall, 2-foot-wide mirror is viewed indirectly, its surface shows faint images of creatures. The mirror weighs 50 pounds, and it has AC 11, HP 10, Immunity to Poison and урон Психический, and Vulnerability to урон Дробящий. It shatters and is destroyed when reduced to 0 Hit Points.
...
Placing the mirror inside an extradimensional space created by a *Сумка вместимости*, *Переносная дыра*, or similar item instantly destroys both items and opens a gate to the Astral Plane. The gate originates where the one item was placed inside the other. Any creature within 10 feet of the gate and not behind Total Cover is sucked through it to a random location on the Astral Plane. The gate then closes. The gate is one-way only and can't be reopened.

#### Мифриловый доспех

*Доспех (Any Medium or Heavy, Except Hide Доспех), Необычный*

Mithral is a light, flexible metal. Armor made of this substance can be worn under normal clothes. If the armor normally imposes Disadvantage on Ловкость (Stealth) checks or has a Сила requirement, the mithral version of the armor doesn't.
...
**_Donjon._** You disappear and become entombed in a state of suspended animation in an extradimensional sphere. Everything you're wearing and carrying disappears with you except for Artifacts, which stay behind in the space you occupied when you disappeared. You remain imprisoned until you are found and removed from the sphere. You can't be located by any Прорицание magic, but a *Исполнение желаний* spell can reveal the location of your prison. You draw no more cards.
...
**_Moon._** You gain the ability to cast *Исполнение желаний* 1d3 times.

**_Puzzle._** Permanently reduce your Интеллект or Мудрость by 1d4 + 1 (to a minimum score of 1). You can draw one additional card beyond your declared draws.

**_Rogue._** An NPC of the GM's choice becomes Hostile toward you. You don't know the identity of this NPC until they or someone else reveals it. Nothing less than a *Исполнение желаний* spell or divine intervention can end the NPC's hostility toward you.
...
> **Initiative** +3 (13)
>
> **ХП** Half the HP maximum of its summoner
>
> **Скорость** 60 ft., Fly 60 ft. (hover)
>
> | Attribute | Score | Mod | Save |
> |-----------|-------|-----|------|
> | Str       | 16    | +3  | +3   |
...
>
>
> **Immunities** Necrotic, Poison; Очарованный, Истощение, Испуганный, Парализованный, Окаменевший, Отравленный, Без сознания
>
> **Senses** Истинное зрение 60 ft., Passive Perception 13
>
> **Languages** All languages known to its summoner
>
> **ПО** None (XP 0; PB equals its summoner's)
>
> ##### Traits
>
> **_Incorporeal Movement._** The avatar can move through other creatures and objects as if they were Difficult Terrain. It takes 5 (1d10) урон Силовое поле if it ends its turn inside an object.
>
> ##### Actions
>
...
>
> **_Reaping Scythe. Melee Attack Roll:_** Automatic hit, reach 5 ft. *Hit:* 7 (1d8 + 3) урон Рубящий plus 4 (1d8) урон Некротический.

#### Ожерелье адаптации

*Чудесный предмет, Необычный (Требует Настройки)*

While wearing this necklace, you can breathe normally in any environment, and you have Advantage on saving throws made to avoid or end the Отравленный condition.

#### Ожерелье огненных шаров

*Чудесный предмет, Редкий*

This necklace has 1d6 + 3 beads hanging from it. You can take a Magic action to detach a bead and throw it up to 60 feet away. When it reaches the end of its trajectory, the bead detonates as a level 3 *Огненный шар* (save DC 15).

You can hurl multiple beads, or even the whole necklace, at one time. When you do so, increase the damage of the *Огненный шар* by 1d6 for each bead after the first (maximum 12d6).

#### Ожерелье молитвенных бусин

*Чудесный предмет, Редкий (Требует Настройки by a Жрец, Друид, or Паладин)*
...
One vial of this oil can cover one Medium or smaller creature, along with the equipment it's wearing and carrying (one additional vial is required for each size category above Medium). Applying the oil takes 10 minutes. The affected creature then gains the effect of the *Эфирность* spell for 1 hour.
...
One vial of this oil can coat one Melee weapon or twenty pieces of ammunition, but only ammunition and Melee weapons that are nonmagical and deal Slashing or урон Колющий are affected. Applying the oil takes 1 minute, after which the oil magically seeps into whatever it coats, turning the coated weapon into a *+3 Weapon* or the coated ammunition into *+3 Ammunition*.
...
One vial of this oil can cover one Medium or smaller creature, along with the equipment it's wearing and carrying (one additional vial is required for each size category above Medium). Applying the oil takes 10 minutes. The affected creature then gains the effect of the *Свобода перемещения* spell for 8 hours.

Alternatively, the oil can be poured on the ground as a Magic action, where it covers a 10-foot square, duplicating the effect of the *Скольжение* spell in that area for 8 hours.

This sticky, black unguent is thick and heavy, but it flows quickly when poured.

#### Жемчужина силы

*Чудесный предмет, Необычный (Требует Настройки by a Spellcaster)*
...
In addition, you have Advantage on saving throws to avoid or end the Отравленный condition while you wear this pendant.

#### Кулон защиты от яда

*Чудесный предмет, Редкий (Требует Настройки)*

This delicate silver chain has a brilliant-cut black gem pendant. While you wear it, you have Immunity to the Отравленный condition and урон Яд.
...
The next time you see a creature within 10 minutes after drinking this philter, you are charmed by that creature and have the Очарованный condition for 1 hour.
...
Whenever a **Swarm of Rats** that isn't under another creature's control comes within 30 feet of you while you are playing the pipes, the swarm makes a DC 15 Мудрость saving throw. On a successful save, the swarm behaves as it normally would and can't be swayed by the pipes' music for the next 24 hours. On a failed save, the swarm is swayed by the pipes' music and becomes Friendly to you and your allies for as long as you continue to play the pipes each round as a Magic action. A Friendly swarm obeys your commands. If you issue no commands to a Friendly swarm, it defends itself but otherwise takes no actions. If a Friendly swarm starts its turn more than 30 feet away from you, your control over that swarm ends, and the swarm behaves as it normally would and can't be swayed by the pipes' music for the next 24 hours.

#### Латный доспех эфирности

*Доспех (Half Plate Доспех or Plate Доспех), Легендарный (Требует Настройки)*

While you're wearing this armor, you can take a Magic action and use a command word to gain the effect of the *Эфирность* spell. The spell ends immediately if you remove the armor or take a Magic action to repeat the command word. This property of the armor can't be used again until the next dawn.
...
You can take a Magic action to unfold a *Переносная дыра* and place it on or against a solid surface, whereupon the *Переносная дыра* creates an extradimensional hole 10 feet deep. The cylindrical space within the hole exists on a different plane of existence, so it can't be used to create open passages. Any creature inside an open *Переносная дыра* can exit the hole by climbing out of it.

You can take a Magic action to close a *Переносная дыра* by taking hold of the edges of the cloth and folding it up. Folding the cloth closes the hole, and any creatures or objects within remain in the extradimensional space. No matter what's in it, the hole weighs next to nothing.

If the hole is folded up, a creature within the hole's extradimensional space can take an action to make a DC 10 Сила (Athletics) check. On a successful check, the creature forces its way out and appears within 5 feet of the *Переносная дыра*. A closed *Переносная дыра* holds enough air for 1 hour of breathing, divided by the number of breathing creatures inside.
...
When you drink this potion, you can cast the level 3 version of the *Дружба с животными* spell (save DC 13).
...
When you drink this potion, you gain the effect of the *Ясновидение* spell (no Concentration required).
...
When you drink this potion, you gain a Climb Speed equal to your Speed for 1 hour. During this time, you have Advantage on Сила (Athletics) checks to climb.
...
When you drink this potion, you gain the "reduce" effect of the *Увеличение/уменьшение* spell for 1d4 hours (no Concentration required).
...
When you drink this potion, you gain the effect of the *Газообразная форма* spell for 1 hour (no Concentration required) or until you end the effect as a Bonus Action.
...
When you drink this potion, your Сила score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Сила is equal to or greater than that score.

This potion's transparent liquid has floating in it a sliver of light resembling a giant's fingernail.

| Potion                                    | Str. | Rarity    |
|---|---|---|
| Potion of Giant Сила (hill)           | 21   | Uncommon  |
| Potion of Giant Сила (frost or stone) | 23   | Rare      |
| Potion of Giant Сила (fire)           | 25   | Rare      |
| Potion of Giant Сила (cloud)          | 27   | Very Rare |
| Potion of Giant Сила (storm)          | 29   | Legendary |

#### Зелье роста

*Зелье, Необычный*

When you drink this potion, you gain the "enlarge" effect of the *Увеличение/уменьшение* spell for 10 minutes (no Concentration required).
...
When you drink this potion, you gain 10 Temporary Hit Points that last for 1 hour. For the same duration, you are under the effect of the *Благословение* spell (no Concentration required).
...
This potion's container looks empty but feels as though it holds liquid. When you drink the potion, you have the Невидимый condition for 1 hour. The effect ends early if you make an attack roll, deal damage, or cast a spell.
...
When you drink this potion, you gain the effect of the *Обнаружение мыслей* spell (save DC 13) for 10 minutes (no Concentration required).
...
This concoction looks, smells, and tastes like a *Potion of Healing* or another beneficial potion. However, it is actually poison masked by illusion magic. *Опознание* reveals its true nature.

If you drink this potion, you take 4d6 урон Яд and must succeed on a DC 13 Телосложение saving throw or have the Отравленный condition for 1 hour.
...
When you drink this potion, you gain the effect of the *Ускорение* spell for 1 minute (no Concentration required) without suffering the wave of lethargy that typically occurs when the effect ends.
...
When you drink this potion, it removes any Истощение levels you have and ends the Отравленный condition on you. For the next 24 hours, you regain the maximum number of Hit Points for any Hit Point Die you spend.
...
*Оружие (Quarterstaff), Very Редкий (Требует Настройки)*
...
**_Acrobatic Assist (Quarterstaff and 10-Foot Pole Forms Only)._** While holding this weapon, you have Advantage on Ловкость (Acrobatics) checks.
...
- *Дружба с животными*
- *Страх* (affects Beasts only)
- *Разговор с животными*

#### Кольцо призыва джинна

*Кольцо, Легендарный (Требует Настройки)*
...
Each *Кольцо повеления стихиями* is linked to one of the four Elemental Planes. The GM chooses or randomly determines the linked plane. For example, a *Кольцо повеления стихиями* (air) is linked to the Elemental Plane of Air.

Every *Кольцо повеления стихиями* has the following two properties:
...
**_Elemental Compulsion._** While wearing the ring, you can take a Magic action to try to compel an Elemental you see within 60 feet of yourself. The Elemental makes a DC 18 Мудрость saving throw. On a failed save, the Elemental has the Очарованный condition until the start your next turn, and you determine what it does with its move and action on its next turn.
...
**Air.** You know Auran, you have Resistance to урон Электричество, and you have a Fly Speed equal to your Speed and can hover.

**Earth.** You know Terran, and you have Resistance to урон Кислота. Terrain composed of rubble, rocks, or dirt isn't Difficult Terrain for you. In addition, you can move through solid earth or rock as if those areas were Difficult Terrain without disturbing the matter through which you pass. If you end your turn in solid earth or rock, you are shunted out to the nearest unoccupied space you last occupied.

**Fire.** You know Ignan, and you have Immunity to урон Огонь.

**Water.** You know Aquan, you gain a Swim Speed of 60 feet, and you can breathe underwater.

**_Использование заклинаний._** The ring has 5 charges and regains 1d4 + 1 expended charges daily at dawn. While wearing the ring, you can cast a spell from it. Choose the spell from the list of available spells based on the Elemental Plane the ring is linked to, as shown in the following table. The table indicates how many charges you must expend to cast the spell, which has a save DC of 18.
...
*Кольцо, Редкий (Требует Настройки)*

This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. When you fail a Ловкость saving throw while wearing the ring, you can take a Reaction to expend 1 charge to succeed on that save instead.
...
While you wear this ring, Difficult Terrain doesn't cost you extra movement. In addition, magic can neither reduce any of your Speeds nor cause you to have the Парализованный or Опутанный condition.

#### Кольцо невидимости

*Кольцо, Легендарный (Требует Настройки)*

While wearing this ring, you can take a Magic action to give yourself the Невидимый condition. You remain Невидимый until the ring is removed or until you take a Bonus Action to become visible again.

#### Кольцо прыжков

*Кольцо, Необычный (Требует Настройки)*

While wearing this ring, you can cast *Прыжок* from it, but can target only yourself when you do so.
...
*Кольцо, Very Редкий (Требует Настройки)*
...
You can cast *Танцующие огоньки* or *Свет* from the ring.

The ring has 6 charges and regains 1d6 expended charges daily at dawn. You can expend its charges to use the properties below.

**_Faerie Fire._** You can expend 1 charge to cast *Огонь фей* from the ring.
...
As a Bonus Action, you can move each sphere up to 30 feet, but no farther than 120 feet away from yourself. The first time the sphere comes within 5 feet of a creature other than you that isn't behind Total Cover, the sphere discharges lightning at that creature and disappears. That creature makes a DC 15 Ловкость saving throw. On a failed save, the creature takes урон Электричество based on the number of spheres you created, as shown in the following table. On a successful save, the creature takes half as much damage.
...
**_Shooting Stars._** You can expend 1 to 3 charges as a Magic action. For every charge you expend, you launch a glowing mote of light from the ring at a point you can see within 60 feet of yourself. Each creature in a 15-foot Cube originating from that point is showered in sparks and makes a DC 15 Ловкость saving throw, taking 5d4 урон Излучение on a failed save or half as much damage on a successful one.
...
*Ring, Very Rare (Requires Attunement)* While wearing this ring, you can cast *Телекинез* from it.

#### Кольцо тарана

*Кольцо, Редкий (Требует Настройки)*

This ring has 3 charges and regains 1d3 expended charges daily at dawn. While wearing the ring, you can take a Magic action to expend 1 to 3 charges to make a ranged spell attack against one creature you can see within 60 feet of yourself. The ring produces a spectral ram's head and makes its attack roll with a +7 bonus. On a hit, for each charge you spend, the target takes 2d10 урон Силовое поле and is pushed 5 feet away from you.

Alternatively, you can expend 1 to 3 of the ring's charges as a Magic action to try to break a nonmagical object you can see within 60 feet of yourself that isn't being worn or carried. The ring makes a Сила check with a +5 bonus for each charge you spend.

#### Кольцо трёх желаний

*Кольцо, Легендарный*

While wearing this ring, you can expend 1 of its 3 charges to cast *Исполнение желаний* from it. The ring becomes nonmagical when you use the last charge.

#### Кольцо тепла

*Кольцо, Необычный (Требует Настройки)*

If you take урон Холод while wearing this ring, the ring reduces the damage you take by 2d8.
...
While wearing this ring, you cast *Хождение по воде* from it, targeting only yourself.
...
Whenever you use the ring again before taking a Long Rest, you must succeed on a DC 15 Телосложение saving throw or gain 1 Истощение level.
...
**All-Around Vision.** The robe gives you Advantage on Мудрость (Perception) checks that rely on sight.

**Special Senses.** You have Тёмное зрение and Истинное зрение, both with a range of 120 feet.

**_Drawbacks._** A *Свет* spell cast on the robe or a *Дневной свет* spell cast within 5 feet of the robe gives you the Ослеплённый condition for 1 minute. At the end of each of your turns, you make a Телосложение saving throw (DC 11 for *Свет* or DC 15 for *Дневной свет*), ending the condition on yourself on a success.

#### Мантия мерцающих цветов

*Чудесный предмет, Very Редкий (Требует Настройки)*

This robe has 3 charges, and it regains 1d3 expended charges daily at dawn. While you wear it, you can take a Magic action and expend 1 charge to cause the garment to display a shifting pattern of dazzling hues until the end of your next turn. During this time, the robe sheds Bright Light in a 30-foot radius and Dim Light for an additional 30 feet, and creatures that can see you have Disadvantage on attack rolls against you. Any creature in the Bright Light that can see you when the robe's power is activated must succeed on a DC 15 Мудрость saving throw or have the Ошеломлённый condition until the effect ends.
...
Six stars, located on the robe's upper-front portion, are particularly large. While wearing this robe, you can take a Magic action to remove one of the stars and expend it to cast the level 5 version of *Магическая стрела*. Daily at dusk, 1d6 removed stars reappear on the robe.
...
*Чудесный предмет, Легендарный (Требует Настройки by a Чародей, Колдун, or Волшебник)*

This elegant garment is made from exquisite cloth and adorned with runes.

You gain these benefits while wearing the robe. *Armor.* If you aren't wearing armor, your base Armor Class is 15 plus your Ловкость modifier. *Magic Resistance.* You have Advantage on saving throws against spells and other magical effects. *War Mage.* Your spell save DC and spell attack bonus each increase by 2.
...
*Жезл, Very Редкий (Требует Настройки)*
...
**_Alertness._** While holding the rod, you have Advantage on Мудрость (Perception) checks and on Initiative rolls.
...
**Button 1.** A fiery blade sprouts from the end opposite the rod's flanged head. The flames shed Bright Light in a 40-foot radius and Dim Light for an additional 40 feet, and the blade functions as a magic Longsword or Shortsword (your choice) that deals an extra 2d6 урон Огонь on a hit.
...
**Button 5.** The rod transforms into a handheld battering ram and grants its user a +10 bonus to Сила (Athletics) checks made to break through doors, barricades, and other barriers.
...
**_Drain Life._** When you hit a creature with a melee attack using the rod, you can force the target to make a DC 17 Телосложение saving throw. On a failed save, the target takes an extra 4d6 урон Некротический, and you regain a number of Hit Points equal to half that урон Некротический. Once used, this property can't be used again until the next dawn.

**_Paralyze._** When you hit a creature with a melee attack using the rod, you can force the target to make a DC 17 Телосложение saving throw. On a failed save, the target has the Парализованный condition for 1 minute. The target repeats the save at the end of each of its turns, ending the effect on a success. Once used, this property can't be used again until the next dawn.

**_Terrify._** While holding the rod, you can take a Magic action to force each creature you can see within 30 feet of yourself to make a DC 17 Мудрость saving throw. On a failed save, a target has the Испуганный condition for 1 minute. A Испуганный target repeats the save at the end of each of its turns, ending the effect on itself on a success. Once used, this property can't be used again until the next dawn.
...
You can take a Magic action to present the rod and command obedience from each creature of your choice that you can see within 120 feet of yourself. Each target must succeed on a DC 15 Мудрость saving throw or have the Очарованный condition for 8 hours. While Очарованный in this way, the creature regards you as its trusted leader. If harmed by you or your allies or commanded to do something contrary to its nature, a target ceases to be Очарованный in this way. Once used, this property can't be used again until the next dawn.
...
The rope has AC 20, HP 20, and Immunity to Poison and урон Психический. It regains 1 Hit Point every 5 minutes as long as it has at least 1 Hit Point. If the rope drops to 0 Hit Points, it is destroyed.

#### Верёвка опутывания

*Чудесный предмет, Редкий*

This rope is 30 feet long. While holding one end of the rope, you can take a Magic action to command the other end to dart forward and entangle one creature you can see within 20 feet of yourself. The target must succeed on a DC 15 Ловкость saving throw or have the Опутанный condition. You can release the target by letting go of your end of the rope (causing the rope to coil up in the target's space) or by using a Bonus Action to repeat the command (causing the rope to coil up in your hand).

A target Опутанный by the rope can take an action to make its choice of a DC 15 Сила (Athletics) or Ловкость (Acrobatics) check. On a successful check, the target is no longer Опутанный by the rope. If you're still holding onto the rope when a target escapes from it, you can take a Reaction to command the rope to coil up in your hand; otherwise, the rope coils up in the target's space.
...
**_Preservation._** The scarab has 12 charges. If you fail a saving throw against a Некромантия spell or a harmful effect originating from an Undead, you can take a Reaction to expend 1 charge and turn the failed save into a successful one. The scarab crumbles into powder and is destroyed when its last charge is expended.

**_Spell Resistance._** You have Advantage on saving throws against spells.

#### Скимитар скорости

*Оружие (Scimitar), Very Редкий (Требует Настройки)*
...
*Доспех (Shield), Необычный*

While holding this Shield, you have Advantage on Initiative rolls and Мудрость (Perception) checks. The Shield is emblazoned with a symbol of an eye.

#### Щит, +1, +2 или +3

*Доспех (Shield), Необычный (+1), Редкий (+2), or Very Редкий (+3)*
...
**_Curse._** This Shield is cursed. Attuning to it curses you until you are targeted by a *Снятие проклятия* spell or similar magic. Removing the Shield fails to end the curse on you. Whenever an attack with a Ranged weapon targets a creature within 10 feet of you, the curse causes you to become the target instead.
...
**_Forceful Bash._** When you take the Attack action, you can make one of the attack rolls using the Shield against a target within 5 feet of yourself. Apply your Proficiency Bonus and Сила modifier to the attack roll. On a hit, the Shield deals урон Силовое поле to the target equal to 2d6 + 2 plus your Сила modifier, and if the target is a creature, you can push it up to 10 feet directly away from yourself. If the creature is your size or smaller, you can also knock it down, giving it the Лежащий condition.
...
This viscous, milky-white substance can form a permanent adhesive bond between any two objects. It must be stored in a jar or flask that has been coated inside with *Масло скольжения*. When found, a container contains 1d6 + 1 ounces.

One ounce of the glue can cover a 1-foot square surface. Applying an ounce of *Суверенный клей* takes a Utilize action, and the applied glue takes 1 minute to set. Once it has done so, the bond it creates can be broken only by the application of *Универсальный растворитель* or *Масло эфирности*, or with a *Исполнение желаний* spell.
...
**_Copying a Scroll into a Spellbook._** A Wizard spell on a *Свиток заклинания* can be copied into a spellbook. When a spell is copied in this way, the copier must succeed on an Интеллект (Arcana) check with a DC equal to 10 plus the spell's level. On a successful check, the spell is copied. Whether the check succeeds or fails, the *Свиток заклинания* is destroyed.
...
The sphere obliterates all matter it passes through and all matter that passes through it. Artifacts are the exception. Unless an Artifact is susceptible to damage from a *Сфера уничтожения*, it passes through the sphere unscathed. Anything else that touches the sphere but isn't wholly engulfed and obliterated by it takes 8d10 урон Силовое поле.

**_Controlling the Sphere._** A *Сфера уничтожения* is stationary until someone takes control of it. If you are within 60 feet of a sphere, you can take a Magic action to make a DC 25 Интеллект (Arcana) check. On a successful check, you control the sphere until the start of your next turn, and if it was under another creature's control, that creature loses control of the sphere. On a failed check, the sphere moves 10 feet toward you in a straight line.

While in control of the sphere, you can take a Bonus Action to cause it to move in one direction of your choice, up to a number of feet equal to 5 times your Интеллект modifier (minimum 5 feet). Any creature whose space the sphere enters must succeed on a DC 19 Ловкость saving throw or be touched by it, taking 8d10 урон Силовое поле. A creature reduced to 0 Hit Points by this damage is obliterated, leaving its possessions behind but no other physical remains.

**_Sphere Interactions._** If the sphere comes into contact with a planar portal (such as that created by the *Врата* spell) or an extradimensional space (such as that within a *Переносная дыра*), the GM determines randomly what happens using the following table.
...
*Посох, Редкий (Требует Настройки by a Бард, Жрец, Друид, Чародей, Колдун, or Волшебник)*

This staff has 10 charges. While holding the staff, you can use any of its properties:

**Cast Spell.** You can expend 1 of the staff's charges to cast *Очарование личности*, *Приказ*, or *Понимание языков* from it using your spell save DC.

**Reflect Очарование.** If you succeed on a saving throw against an Очарование spell that targets only you, you can take a Reaction to expend 1 charge from the staff and turn the spell back on its caster as if you had cast the spell.

**Resist Очарование.** If you fail a saving throw against an Очарование spell that targets only you, you can turn your failed save into a successful one. You can't use this property of the staff again until the next dawn.
...
*Посох, Very Редкий (Требует Настройки by a Друид, Чародей, Колдун, or Волшебник)*

You have Resistance to урон Огонь while you hold this staff.
...
You have Resistance to урон Холод while you hold this staff.
...
*Посох, Редкий (Требует Настройки by a Бард, Жрец, or Друид)*
...
*Посох, Very Редкий (Требует Настройки by a Чародей, Колдун, or Волшебник)*
...
**_Retributive Strike._** You can take a Magic action to break the staff over your knee or against a solid surface. The staff is destroyed and releases its magic in an explosion that fills a 30-foot Emanation originating from itself. You have a 50 percent chance to instantly travel to a random plane of existence, avoiding the explosion. If you fail to avoid the effect, you take урон Силовое поле equal to 16 times the number of charges in the staff. Each other creature in the area makes a DC 17 Ловкость saving throw. On a failed save, a creature takes урон Силовое поле equal to 4 times the number of charges in the staff. On a successful save, a creature takes half as much damage.

#### Посох поражения

*Посох, Very Редкий (Требует Настройки)*

This staff can be wielded as a magic Quarterstaff that grants a +3 bonus to attack rolls and damage rolls made with it.

The staff has 10 charges. When you hit with a melee attack using it, you can expend up to 3 charges. For each charge you expend, the target takes an extra 1d6 урон Силовое поле.
...
*Посох, Легендарный (Требует Настройки by a Чародей, Колдун, or Волшебник)*
...
**_Retributive Strike._** You can take a Magic action to break the staff over your knee or against a solid surface. The staff is destroyed and releases its magic in an explosion that fills a 30-foot Emanation originating from itself. You have a 50 percent chance to instantly travel to a random plane of existence, avoiding the explosion. If you fail to avoid the effect, you take урон Силовое поле equal to 16 times the number of charges in the staff. Each other creature in the area makes a DC 17 Ловкость saving throw. On a failed save, a creature takes урон Силовое поле equal to 6 times the number of charges in the staff. On a successful save, a creature takes half as much damage.
...
On your turn, you can mentally command the snake (no action required) if it is within 60 feet of you and you don't have the Недееспособный condition. You decide what action the snake takes and where it moves during its turn, or you can issue it a general command, such as to attack your enemies or guard a location. Absent commands from you, the snake defends itself.
...
*Посох, Редкий (Требует Настройки by a Друид)*
...
**_Lightning._** When you hit with a melee attack using the staff, you can cause the target to take an extra 2d6 урон Электричество (no action required).

**_Thunder._** When you hit with a melee attack using the staff, you can cause the staff to emit a crack of thunder audible out to 300 feet (no action required). The target you hit must succeed on a DC 17 Телосложение saving throw or have the Ошеломлённый condition until the end of your next turn.
...
**_Lightning Strike._** You can take a Magic action to cause a bolt of lightning to leap from the staff's tip in a Line that is 5 feet wide and 120 feet long. Each creature in that Line makes a DC 17 Ловкость saving throw, taking 9d6 урон Электричество on a failed save or half as much damage on a successful one.

**_Thunderclap._** You can take a Magic action to cause the staff to produce a thunderclap audible out to 600 feet. Every creature within a 60-foot Emanation originating from you makes a DC 17 Телосложение saving throw. On a failed save, a creature takes 2d6 урон Гром and has the Оглохший condition for 1 minute. On a successful save, a creature takes half as much damage only.
...
The staff can be wielded as a magic Quarterstaff. On a hit, it deals damage as a normal Quarterstaff, and you can expend 1 charge to deal an extra 2d10 урон Некротический to the target and force it to make a DC 15 Телосложение saving throw. On a failed save, the target has Disadvantage for 1 hour on any ability check or saving throw that uses Сила or Телосложение.
...
*Оружие (Longsword), Редкий (Требует Настройки)*
...
You gain a +2 bonus to attack rolls and damage rolls made with this weapon, which deals урон Излучение instead of урон Рубящий. When you hit an Undead with it, that target takes an extra 1d8 урон Излучение.
...
*Оружие (Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Редкий (Требует Настройки)*

When you attack a creature with this magic weapon and roll a 20 on the d20 for the attack roll, that target takes an extra 15 урон Некротический if it isn't a Construct or an Undead, and you gain Temporary Hit Points equal to the amount of урон Некротический taken.

#### Меч остроты

*Оружие (Glaive, Greatsword, Longsword, or Scimitar), Very Редкий (Требует Настройки)*

When you attack an object with this magic weapon and hit, maximize your weapon damage dice against the target.

When you attack a creature with this weapon and roll a 20 on the d20 for the attack roll, that target takes an extra 14 урон Рубящий and gains 1 Истощение level.

#### Меч ран

*Оружие (Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Редкий (Требует Настройки)*

When you hit a creature with an attack using this magic weapon, the target takes an extra 2d6 урон Некротический and must succeed on a DC 15 Телосложение saving throw or be unable to regain Hit Points for 1 hour. The target repeats the save at the end of each of its turns, ending the effect on itself on a success.

#### Талисман чистого добра

*Чудесный предмет, Легендарный (Требует Настройки by a Жрец or Паладин)*

This talisman is a mighty symbol of goodness. A Fiend or an Undead that touches the talisman takes 8d6 урон Излучение and takes the damage again each time it ends its turn holding or carrying the talisman.
...
**_Pure Rebuke._** The talisman has 7 charges. While wearing or holding the talisman, you can take a Magic action to expend 1 charge and target one creature you can see on the ground within 120 feet of yourself. A flaming fissure opens under the target, and the target makes a DC 20 Ловкость saving throw. If the target is a Fiend or an Undead, it has Disadvantage on the save. On a failed save, the target falls into the fissure and is destroyed, leaving no remains. On a successful save, the target isn't cast into the fissure but takes 4d6 урон Психический from the ordeal. In either case, the fissure then closes, leaving no trace of its existence. When you expend the last charge, the talisman disperses into motes of golden light and is destroyed.

#### Талисман сферы

*Чудесный предмет, Легендарный (Требует Настройки)*

While holding or wearing this talisman, you have Advantage on any Интеллект (Arcana) check you make to control a *Сфера уничтожения*. In addition, when you start your turn in control of a *Сфера уничтожения*, you can take a Magic action to move it 10 feet plus a number of additional feet equal to 10 times your Интеллект modifier. This movement doesn't have to be in a straight line.

#### Талисман абсолютного зла

*Чудесный предмет, Легендарный (Требует Настройки)*

This item symbolizes unrepentant evil. A creature that isn't a Fiend or an Undead that touches the talisman takes 8d6 урон Некротический and takes the damage again each time it ends its turn holding or carrying the talisman.

**_Holy Symbol._** You can use the talisman as a Holy Symbol. You gain a +2 bonus to spell attack rolls while you wear or hold it.

**_Ultimate End._** The talisman has 6 charges. While wearing or holding the talisman, you can take a Magic action to expend 1 charge and target one creature you can see on the ground within 120 feet of yourself. A flaming fissure opens under the target, and the target makes a DC 20 Ловкость saving throw. If the target is a Celestial, it has Disadvantage on the save. On a failed save, the target falls into the fissure and is destroyed, leaving no remains. On a successful save, the target isn't cast into the fissure but takes 4d6 урон Психический from the ordeal. In either case, the fissure then closes, leaving no trace of its existence. When you expend the last charge, the talisman dissolves into foul-smelling slime and is destroyed.

#### Громовая дубина

*Оружие (Greatclub), Very Редкий (Требует Настройки)*

While you are attuned to this magic weapon, your Сила is 20 unless your Сила is already equal to or greater than that score. The weapon deals an extra 1d8 урон Гром to any creature it hits and an extra 3d8 урон Гром to objects it hits that aren't being worn or carried.

The weapon has the following additional properties.

**_Clap of Thunder._** As a Magic action, you can strike the weapon against a hard surface to create a loud clap of thunder audible out to 300 feet. You also create a 30-foot Cone of thunderous energy. Each creature in the Cone must succeed on a DC 15 Сила saving throw or have the Лежащий condition. Nonmagical objects in the Cone that aren't being worn or carried take 3d8 урон Гром.

**_Earthquake._** As a Magic action, you can strike the weapon against the ground to create an intense seismic disturbance in a 50-foot-radius circle centered on the point of impact. Structures in contact with the ground in that area take 50 урон Дробящий, and each creature on the ground in that area must succeed on a DC 20 Ловкость saving throw or have the Лежащий condition. If that creature is also concentrating, it must succeed on a DC 20 Телосложение saving throw, or its Concentration is broken. In addition, you can cause a 30-foot-deep, 10-foot-wide fissure to open up on the ground anywhere in the area. Any creature on a spot where the fissure opens must make a DC 20 Ловкость saving throw, falling into the fissure on a failed save or moving with the fissure's edge on a successful one. Any structure on a spot where the fissure opens collapses into the fissure. Once you use this property, it can't be used again until the next dawn.

#### Том ясной мысли

*Чудесный предмет, Very Редкий*

This book contains memory and logic exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Интеллект increases by 2, to a maximum of 30. The manual then loses its magic but regains it in a century.

#### Том лидерства и влияния

*Чудесный предмет, Very Редкий*

This book contains guidelines for influencing and charming others, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Харизма increases by 2, to a maximum of 30. The manual then loses its magic but regains it in a century.

#### Том понимания

*Чудесный предмет, Very Редкий*

This book contains intuition and insight exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Мудрость increases by 2, to a maximum of 30. The manual then loses its magic, but regains it in a century.

#### Трезубец повелителя рыб

*Оружие (Trident), Необычный (Требует Настройки)*

This magic weapon has 3 charges, and it regains 1d3 expended charges daily at dawn. While you carry it, you can expend 1 charge to cast *Подчинение зверя* (save DC 15) from it on a Beast that has a Swim Speed.
...
You can take a Utilize action to pour 1 or more ounces of solvent from the tube onto a surface within reach. Each ounce instantly dissolves up to 1 square foot of adhesive it touches, including *Суверенный клей*.
...
*Оружие (Glaive, Greatsword, Longsword, or Scimitar), Легендарный (Требует Настройки)*

You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. In addition, the weapon ignores Resistance to урон Рубящий.

When you use this weapon to attack a creature that has at least one head and roll a 20 on the d20 for the attack roll, you cut off one of the creature's heads. The creature dies if it can't survive without the lost head. A creature is immune to this effect if it has Immunity to урон Рубящий, if it doesn't have or need a head, or if the GM decides that the creature is too big for its head to be cut off with this weapon. Such a creature instead takes an extra 30 урон Рубящий from the hit. If the creature has Legendary Resistance, it can expend one daily use of that trait to avoid losing its head, taking the extra damage instead.

#### Волшебная палочка связывания

*Палочка, Редкий (Требует Настройки)*
...
This wand has 7 charges. While holding it, you can take a Magic action to expend 1 charge. For 1 minute, you know the direction of the nearest creature Hostile to you within 60 feet, but not its distance from you. The wand can sense the presence of Hostile creatures that are Невидимый, ethereal, disguised, or hidden, as well as those in plain sight. The effect ends if you stop holding the wand.
...
*Палочка, Редкий (Требует Настройки by a Spellcaster)*

This wand has 7 charges. While holding it, you can expend no more than 3 charges to cast *Огненный шар* (save DC 15) from it. For 1 charge, you cast the level 3 version of the spell. You can increase the spell's level by 1 for each additional charge you expend.
...
This wand has 7 charges. While holding it, you can expend no more than 3 charges to cast *Молния* (save DC 15) from it. For 1 charge, you cast the level 3 version of the spell. You can increase the spell's level by 1 for each additional charge you expend.
...
This wand has 3 charges. While holding it, you can expend 1 charge to cast *Обнаружение магии* from it. The wand regains 1d3 expended charges daily at dawn.

#### Волшебная палочка волшебных стрел

*Палочка, Необычный*

This wand has 7 charges. While holding it, you can expend no more than 3 charges to cast *Магическая стрела* from it. For 1 charge, you cast the level 1 version of the spell. You can increase the spell's level by 1 for each additional charge you expend.
...
This wand has 7 charges. While holding it, you can take a Magic action to expend 1 charge to cause a thin blue ray to streak from the tip toward a creature you can see within 60 feet of yourself. The target must succeed on a DC 15 Телосложение saving throw or have the Парализованный condition for 1 minute. At the end of each of the target's turns, it repeats the save, ending the effect on itself on a success.

**_Regaining Charges._** The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll 1d20. On a 1, the wand crumbles into ashes and is destroyed.

#### Волшебная палочка превращения

*Палочка, Very Редкий (Требует Настройки by a Spellcaster)*

This wand has 7 charges. While holding it, you can expend 1 charge to cast *Превращение* (save DC 15) from it.
...
*Палочка, Необычный (+1), Редкий (+2), or Very Редкий (+3) (Требует Настройки by a Spellcaster)*
...
*Палочка, Необычный (Требует Настройки by a Spellcaster)*

This wand has 7 charges. While holding it, you can expend 1 charge to cast *Паутина* (save DC 13) from it.
...
| 1d100 | Effect |
|---|---|
| 01–20 | You cast a spell originating from the chosen point. Roll 1d10 to determine the spell: on a **1–2,** *Тьма*; on a **3–4,** *Огонь фей*; on a **5–6,** *Огненный шар*; on a **7–8,** *Замедление*; on a **9–10,** *Удушающее облако*. |
| 21–25 | Nothing happens at the chosen point of origin. Instead, you have the Ошеломлённый condition until the start of your next turn, believing something awesome just happened. |
| 26–30 | You cast *Порыв ветра*. The Line created by the spell extends from you to the chosen point of origin. |
| 31–35 | Nothing happens at the chosen point of origin. Instead, you take 1d6 урон Психический. |
...
| 46–50 | You cast *Молния*. The Line created by the spell extends from you to the chosen point of origin. |
...
| 78–82 | Nothing happens at the chosen point of origin. Instead, a burst of colorful, shimmering light extends from you in a 30-foot Emanation. Each creature in the area must succeed on a DC 15 Телосложение saving throw or have the Ослеплённый condition for 1 minute. A creature repeats the save at the end of each of its turns, ending the effect on itself on a success. |
| 83–87 | Nothing happens at the chosen point of origin. Instead, you cast *Невидимость* on yourself. |
| 88–92 | Nothing happens at the chosen point of origin. Instead, a stream of 1d4 × 10 gems, each worth 1 GP, shoots from the wand's tip in a Line 30 feet long and 5 feet wide toward the chosen point of origin. Each gem deals 1 урон Дробящий, and the total damage of the gems is divided equally among all creatures in the Line. |
| 93–97 | You cast *Превращение*, targeting the creature closest to the chosen point of origin. Roll 1d4 to determine the target's new form. On a **1,** the new form is a **Black Bear;** on a **2,** the new form is a **Giant Wasp;** on a **3–4,** the new form is a **Frog.** |
| 98–00 | The creature closest to the chosen point of origin makes a DC 15 Телосложение saving throw. On a failed save, the creature has the Опутанный condition and begins to turn to stone. While Опутанный in this way, the creature repeats the save at the end of its next turn. On a successful save, the effect ends. On a failed save, the creature has the Окаменевший condition instead of the Опутанный condition. The petrification lasts until the creature is freed by the *Высшее восстановление* spell or similar magic. |

#### Оружие, +1, +2 или +3

*Оружие (Any Simple or Martial), Необычный (+1), Редкий (+2), or Very Редкий (+3)*
...
*Оружие (Any Simple or Martial), Необычный (Требует Настройки)*
...
You can take a Magic action to unfold the *Колодец многих миров* and place it on a solid surface, whereupon it forms a two-way, 6-foot-diameter, circular portal to another world or plane of existence. Each time the item opens a portal, the GM decides where it leads. The portal remains open until a creature within 5 feet of it takes a Magic action to close it by taking hold of the edges of the cloth and folding it up.

Once the *Колодец многих миров* has opened a portal, it can't do so again for 1d8 hours.

#### Ветряной веер

*Чудесный предмет, Необычный*

While holding this fan, you can cast *Порыв ветра* (save DC 13) from it. Each subsequent time the fan is used before the next dawn, it has a cumulative 20 percent chance of not working; if the fan fails to work, it tears into useless, nonmagical tatters.
