...
## Справочный документ системы

**Greg Stafford, Steve Perrin, Jeff Richard и Jason Durall**

## Правовая информация

Справочный документ системы *Basic Roleplaying* 1.0 (BRPSRD1.0) описывает правила *Basic Roleplaying*. Вы можете включить правила в том виде, в каком они представлены в BRPSRD1.0, полностью или частично, в производное произведение, используя Открытую игровую лицензию *BRP* версии 1.0. Перед созданием производного произведения на основе BRPSRD1.0 вам следует ознакомиться с условиями этой лицензии и понять их.

Благодарим Wizards of the Coast, Open Source Initiative и Creative Commons за их работу по созданию основы для открытых (и, в данном случае, открытых игровых) лицензий. Обратите внимание, что Открытая игровая лицензия *BRP* для использования системы *Basic Roleplaying* отличается от Открытой игровой лицензии Wizards и имеет иные условия и положения.

### *BRP* Open Game License, Version 1.0
...
*BRP* Open Game License v 1.0 (c) copyright 2020 Chaosium Inc. *Basic Roleplaying* (c) copyright 1980–2020 Chaosium Inc.; Authors, original rules: Greg Stafford, Steve Henderson, Warren James, Steve Perrin, Sandy Petersen, Ray Turney, and Lynn Willis; developed by Jason Durall, James Lowder, and Jeff Richard.
