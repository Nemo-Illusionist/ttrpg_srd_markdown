...
Этот раздел описывает процесс создания игрового персонажа для *Basic Roleplaying*. Процедура создания неигрового персонажа менее сложна и рассматривается далее.
...
- **Хиты:** Значение, определяющее, сколько урона игровой персонаж может получить, прежде чем погибнет. Крупные и/или здоровые персонажи имеют больше хитов (ХТ), тогда как мелкие и/или хрупкие — меньше.
...
Характеристики: *Сила*, *Телосложение*, *Размер*, *Интеллект*, *Воля*, *Ловкость* и *Внешность*; они описаны ниже.
...
- **Телосложение (ТЕЛ):** Телосложение — это мера выносливости и стойкости персонажа. Оно помогает сопротивляться болезням, но главное значение ТЕЛ — определение того, сколько повреждений персонаж может выдержать до смерти. Бросьте 3D6 для определения ТЕЛ.
...
Если числа совершенно не соответствуют желаемому типу персонажа, игроку следует спросить Ведущего, можно ли начать заново и бросить новый набор характеристик. Это допустимо, если все игроки имеют такую же возможность и довольны результатами.
...
Каждый бросок характеристики выполняется против характеристики, умноженной на 5, и выражается как процентный шанс. Например, СИЛ 10 даёт Бросок Усилия 10×5=50, то есть 50%.

- **Бросок Усилия:** Бросок Усилия используется при силовом воздействии на предмет или элемент окружения. Он основан на СИЛ×5. *Попытка выполнить сто отжиманий требует Броска Усилия.*
- **Бросок Выносливости:** Бросок Выносливости используется при длительном физическом напряжении и испытаниях стойкости. Он основан на ТЕЛ×5. *Попытка не подхватить простуду или выпить целую бутылку заправки для салата требует Броска Выносливости.*
- **Бросок Идеи:** Бросок Идеи используется для вспышки вдохновения или чтобы определить, «знает» ли персонаж то, что знает игрок, либо чтобы персонаж догадался о том, о чём не догадался игрок. Ведущий иногда может использовать этот бросок, чтобы подтолкнуть игроков, когда они не знают, что делать дальше (но их персонажи знали бы). Он основан на ИНТ×5. *Обнаружение закономерности в серии мест преступлений, отмеченных на карте города, требует Броска Идеи.*
- **Бросок Удачи:** Бросок Удачи определяет, улыбнётся ли судьба персонажу или удастся ли ему выкрутиться в ситуации, где решающим фактором является случайность (например, рулетка). Он основан на ВОЛ×5. *Определение победителя при подбрасывании монеты или вытягивании короткой соломинки требует Броска Удачи.*
- **Бросок Проворства:** Бросок Проворства полезен для ситуаций, где природная координация важнее любой подготовки, например бег по скользкой поверхности или попытка поймать уроненный предмет до того, как он упадёт. Он основан на ЛОВ×5. *Поймать предмет, брошенный в персонажа с криком «Лови!», требует Броска Проворства.*
- **Бросок Обаяния:** Чистая харизма; способность положиться на привлекательную внешность и личное обаяние, чтобы привлечь внимание или повлиять на других. Он основан на ВНШ×5. *Попытка привлечь внимание вышибалы, чтобы попасть в эксклюзивный клуб, требует Броска Обаяния.*
...
- **Хиты:** Хиты (ХТ) равны ТЕЛ+РАЗ персонажа, делённым на два (дроби округляются вверх). Они вычитаются по мере получения персонажем урона от ранений или других источников. Когда хиты персонажа падают до 1 или 2, он теряет сознание. Когда боевой раунд заканчивается, а у персонажа 0 хитов — персонаж мёртв.
...
- **Торговля (05%):** Успешное ведение финансовых переговоров. Успешное применение этого навыка снижает цену предмета на одну ценовую категорию (недостижимая > бесценная > дорогая > приемлемая > недорогая > дешёвая > бесплатная) по усмотрению Ведущего. Эти категории являются ориентировочными и могут быть изменены по желанию.
...
- **Язык (разное) (Родной ИНТ×5, Другой 00%):** Умение говорить и понимать язык. Язык (Родной) — родной язык персонажа, начинается на уровне ИНТ×5. Как правило, игровым персонажам не нужно делать броски Языка, чтобы общаться на родном языке с другими носителями того же языка. Язык (Другой) — другой язык, начинается с 00%. Каждый другой Язык является специализацией.
...
- **Техника (разное) (00%):** Использование сложного оборудования или технического процесса. Базовый шанс варьируется в зависимости от сеттинга и определяется Ведущим. Каждый тип навыка Техника является специализацией: Программирование, Компьютеры, Электроника, Робототехника, Сенсорные системы, Осадные орудия, Ловушки и т. д.
...
В качестве альтернативы готовым профессиям Ведущий может позволить игроку создать новую профессию для своего персонажа. Для этого выберите подходящее название профессии и десять подходящих навыков, на которые распределяются 300 очков профессиональных навыков.
...
- Прочие предметы, уместные с учётом навыка Статус, сеттинга и по одобрению Ведущего.

Это может быть изменено Ведущим в зависимости от обстоятельств: персонажи, участвующие в рейде коммандос, могут быть полностью экипированы оружием и тактическим снаряжением, тогда как пригородные жители, проснувшиеся во время зомби-апокалипсиса, могут быть ограничены тем, что разумно окажется под рукой.

## 2.10 Завершающие штрихи

Все основные аспекты характера и предыстории следует определить на этом этапе. Ведущий может пожелать узнать больше о прошлом персонажа для использования в кампании. Это может включать происхождение, семью, образование, религию, прошлые поступки или цели. Как правило, чем больше игрок знает о своём персонаже, тем более «реальным» тот становится в игре, хотя это не всегда обязательно. Создать слишком много предыстории столь же плохо, как и создать слишком мало.

Каждый игрок должен создать столько предыстории, сколько ему комфортно. Для разового сценария, вероятно, не требуется подробная предыстория, но для длительной кампании Ведущему и другим игрокам может быть трудно представить персонажа, если недостаточно информации.

Ведущий *всегда* имеет право наложить вето на всё, что неприемлемо или не вписывается в желаемый сеттинг или тональность.
