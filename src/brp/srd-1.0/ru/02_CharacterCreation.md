...
Если числа совершенно не соответствуют желаемому типу персонажа, игроку следует спросить Ведущего (ВД), можно ли начать заново и бросить новый набор характеристик. Это допустимо, если все игроки имеют такую же возможность и довольны результатами.
...
Любые очки навыков, которые персонаж имеет в навыке, добавляются к базовому шансу навыка. Базовые шансы навыков могут быть скорректированы Ведущим (ВД) в зависимости от сеттинга.
...
- **Техника (разное) (00%):** Использование сложного оборудования или технического процесса. Базовый шанс варьируется в зависимости от сеттинга и определяется Ведущим (ВД). Каждый тип навыка Техника является специализацией: Программирование, Компьютеры, Электроника, Робототехника, Сенсорные системы, Осадные орудия, Ловушки и т. д.
...
При необходимости Ведущий (ВД) может изменить список навыков, чтобы он лучше соответствовал конкретному сеттингу. Ведущий (ВД) может убирать навыки, переименовывать их или вводить новые. *Например, в средневековом фэнтезийном сеттинге, скорее всего, не используются Энергетическое оружие, Тяжёлая техника, Психотерапия и Техника.* Начальные уровни навыков также могут быть скорректированы для конкретной кампании или сеттинга.
...
В качестве альтернативы готовым профессиям Ведущий (ВД) может позволить игроку создать новую профессию для своего персонажа. Для этого выберите подходящее название профессии и десять подходящих навыков, на которые распределяются 300 очков профессиональных навыков.
...
Ведущий (ВД) может попросить игроков не поднимать ни один навык выше 75% (если только базовый навык не выше 75%) и чтобы личные навыки, выбранные на этом этапе, имели смысл для персонажа.
...
- Прочие предметы, уместные с учётом навыка Статус, сеттинга и по одобрению Ведущего (ВД).

Это может быть изменено Ведущим (ВД) в зависимости от обстоятельств: персонажи, участвующие в рейде коммандос, могут быть полностью экипированы оружием и тактическим снаряжением, тогда как пригородные жители, проснувшиеся во время зомби-апокалипсиса, могут быть ограничены тем, что разумно окажется под рукой.

## 2.10 Завершающие штрихи

Все основные аспекты характера и предыстории следует определить на этом этапе. Ведущий (ВД) может пожелать узнать больше о прошлом персонажа для использования в кампании. Это может включать происхождение, семью, образование, религию, прошлые поступки или цели. Как правило, чем больше игрок знает о своём персонаже, тем более «реальным» тот становится в игре, хотя это не всегда обязательно. Создать слишком много предыстории столь же плохо, как и создать слишком мало.

Каждый игрок должен создать столько предыстории, сколько ему комфортно. Для разового сценария, вероятно, не требуется подробная предыстория, но для длительной кампании Ведущему (ВД) и другим игрокам может быть трудно представить персонажа, если недостаточно информации.

Ведущий (ВД) *всегда* имеет право наложить вето на всё, что неприемлемо или не вписывается в желаемый сеттинг или тональность.
