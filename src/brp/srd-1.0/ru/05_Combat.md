...
Ведущий и игроки, участвующие в боевом раунде, должны объявить, что они будут делать. Порядок, в котором можно предпринимать действия, определяется характеристикой ЛОВ каждого персонажа. Игрокам и Ведущим не нужно объявлять защитные действия (парирования, уклонения и т. д.) во время этой фазы.

Заявки действия должны обрабатываться в порядке характеристики ЛОВ всех участвующих персонажей, от наибольшей к наименьшей. Игрок персонажа с высоким рангом ЛОВ делает заявку действия раньше персонажа с низким рангом ЛОВ. Обычно Ведущий ведёт отсчёт от наивысшего значения ЛОВ до наименьшего, обращаясь к каждому игроку с просьбой заявить намеченные действия в подходящий момент и объявляя, как будут действовать неигровые персонажи (НИП) при соответствующих значениях ЛОВ.
...
По усмотрению Ведущего может быть использована родственная специализация навыка как *Сложная* (1/2 шанса). *Например, Ведущий может разрешить персонажу использовать меч с навыком кинжала, поскольку оба являются специализациями оружия ближнего боя и похожим оружием.*
...
Оружие и щиты иногда получают урон при парировании и могут даже сломаться, если их хиты (ХТ) исчерпаны.
...
- Хиты (ХТ) оружия при использовании для парирования.
...
| Оружие | Навык | Специализация | Базовый | Урон | Руки | ХТ |
|---|---|---|---|---|---|---|
...
| Оружие | Навык | Специализация | Базовый | Урон | Руки | ХТ | Дальность |
|---|---|---|---|---|---|---|---|
...
К «физическим» навыкам относятся: Лазание, Уклонение, Тонкая работа, Прятки, Прыжки, Ловкость рук, Скрытность, Плавание и Метание, а также бросок характеристики Ловкости; к навыкам «восприятия» — Слух и Наблюдательность. По усмотрению Ведущего другие навыки тоже могут быть затронуты ношением брони.
...
Щиты описываются базовым шансом парирования или атаки, уроном при использовании в качестве оружия (удар щитом и т. д.) и очками брони. Если щит неподвижен, используйте его очки брони для определения того, сколько очков он защищает, а если он повреждён, уменьшите его хиты (ХТ) и очки брони, чтобы отразить полученный урон и сниженную способность защищать.

### Таблица щитов

| Название | Базовый шанс | Навык | Броня/ХТ | Урон |
|---|---|---|---|---|
...
Каждый персонаж имеет хиты (ХТ), вычисленные из среднего значения Телосложения и Размера (см. раздел **2.5 Производные характеристики**). Когда оружие успешно поражает персонажа (или персонаж получает какое-либо другое ранение), очки урона (после вычета очков брони) вычитаются из его текущих хитов.
...
Персонаж обычно восстанавливает 1D3 хитов за игровую неделю. Это означает, что в конце семидневного периода Ведущий бросает 1D3, и персонаж восстанавливает столько хитов (до максимального значения хитов). Если персонаж находится в больнице в идеальных условиях и получает первоклассное медицинское лечение, Ведущий может разрешить максимальное исцеление (3) вместо броска 1D3.
