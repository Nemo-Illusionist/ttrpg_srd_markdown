...
<sup>\*</sup>The time and cost are halved for a consumable item other than a *Spell Scroll*, whose crafting time and cost are given in "Equipment."
...
| 5 | Each extended claw makes the following melee attack:<br>+8 to hit, reach 5 ft. Hit: 7 (2d6) Bludgeoning damage. | Each extended claw makes the following melee attack:<br>+8 to hit, reach 5 ft. Hit: The target has the Grappled<br>condition (escape DC 15). |
...
| Belt of Giant Strength (frost or<br>stone) | 23 | Very Rare |
...
| 1d100<br>Outer Plane | | 1d100 | Outer Plane |
|----------------------|------------|-------|----------------|
...
<sup>\*</sup>Stat blocks for these creatures (except the card drawer) appear in "Monsters."
...
*Armor (Scale Mail), Very Rare (Requires Attunement) Dragon Scale Mail* is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them. Other times, hunters carefully preserve the hide of a dead dragon. In either case, *Dragon Scale Mail* is highly valued.
...
**AC** 11 **Initiative** +1 (11) **HP** 19 (3d10 + 3) **Speed** 30 ft., Fly 60 ft.
...
*Moon.* You gain the ability to cast *Wish* 1d3 times. *Puzzle.* Permanently reduce your Intelligence or Wisdom by 1d4 + 1 (to a minimum score of 1). You can draw one additional card beyond your declared draws.
...
| Potion of Giant Strength (frost or<br>stone) | 23 | Rare |
...
| Potion of Healing<br>(greater) | 4d4 + 4 | Uncommon |
| Potion of Healing<br>(superior) | 8d4 + 8 | Rare |
| Potion of Healing<br>(supreme) | 10d4 + 20 | Very Rare |
...
|-------|---------------------------------------------------------------------------------------------------------------------------------------|
| Air | Chain Lightning (3 charges), Feather Fall (0<br>charges), Gust of Wind (2 charges), Wind<br>Wall (1 charge) |
| Earth | Earthquake (5 charges), Stone Shape (2<br>charges), Stoneskin (3 charges), Wall of Stone<br>(3 charges) |
| Fire | Burning Hands (1 charge), Fireball (2 charges),<br>Fire Storm (4 charges), Wall of Fire (3 charges) |
| Water | Create or Destroy Water (1 charge), Ice Storm<br>(2 charges), Tsunami (5 charges), Wall of Ice<br>(3 charges), Water Walk (2 charges) |
...
You gain these benefits while wearing the robe. *Armor.* If you aren't wearing armor, your base Armor Class is 15 plus your Dexterity modifier.
...
97–00 Portable Ram bonus to Armor Class and saving throws and can sense the location of any Invisible creature that is also in the Bright Light.
...
| 51–85 | The sphere moves through the portal or into<br>the extradimensional space. |
| 86–00 | A spatial rift sends the sphere and each crea<br>ture and object within 180 feet of the sphere<br>to a random plane of existence. |
...
| Spell | Charge Cost |
|--------------------|----------------------------------------------------------------|
| Cure Wounds | 1 charge per spell level<br>(maximum 4 for a level 4<br>spell) |
