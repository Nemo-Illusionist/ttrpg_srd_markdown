...
| Saving Throw<br>Proficiencies | Strength and Dexterity |
| Skill Proficiencies | Choose 2: Acrobatics, Athlet<br>ics, History, Insight, Religion,<br>or Stealth |
| Weapon Proficiencies | Simple weapons and Martial<br>weapons that have the Light<br>property |
| Tool Proficiencies | Choose one type of Artisan's<br>Tools or Musical Instrument (see<br>"Equipment") |
| Armor Training | None |
| Starting Equipment | Choose A or B: (A) Spear, 5<br>Daggers, Artisan's Tools or<br>Musical Instrument chosen<br>for the tool proficiency above,<br>Explorer's Pack, and 11 GP; or<br>(B) 50 GP |
...
| Level | Proficiency<br>Bonus | Class Features | Martial<br>Arts | Focus<br>Points | Unarmored<br>Movement |
|-------|----------------------|---------------------------------------------------------|-----------------|-----------------|-----------------------|
| 1 | +2 | Martial Arts, Unarmored Defense | 1d6 | — | — |
| 2 | +2 | Monk's Focus, Unarmored Movement,<br>Uncanny Metabolism | 1d6 | 2 | +10 ft. |
